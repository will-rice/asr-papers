...
1.  1.  The acoustic space spanned by the low-resource language is a subspace of that of the high-resource language. This requires the phoneme set of the low-resource language to be a subset of the high-resource language.
2.  2.  There exists a high-resource language with reasonable amount of paired audio data and transcriptions to build an ASR.
3.  3.  The low-resource language has enough text data available to train the language models.
4.  4.  The speech data available in the low-resource language is quite limited, and the transcriptions are not available.
