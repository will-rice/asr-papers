...
arxiv_id: "1905.06655"
title:
  Effective Sentence Scoring Method using Bidirectional Language Model for Speech
  Recognition
authors:
  - Joongbo Shin
  - Yoonhyung Lee
...
- •
  ...
  - 1.  Input $`=`$ \<M\> the vat over the hot fire
  - Label $`=`$ move
  - 2.  Input $`=`$ move \<M\> vat over the hot fire
  - Label $`=`$ the
  - $`\cdots`$
  - 7.  Input $`=`$ move the vat over the hot \<M\>
  - Label $`=`$ fire
...
- \[1\] K. Heafield, I. Pouzyrevsky, J. H. Clark, and P. Koehn, “Scalable modified kneser-ney language model estimation,” in _Proceedings of the 51st Annual Meeting of the Association for Computational Linguistics (Volume 2: Short Papers)_, vol. 2, 2013, pp. 690–696.
- \[2\] T. Mikolov, M. Karafiát, L. Burget, J. Černockỳ, and S. Khudanpur, “Recurrent neural network based language model,” in _Eleventh annual conference of the international speech communication association_, 2010.
- \[3\] M. Peters, M. Neumann, M. Iyyer, M. Gardner, C. Clark, K. Lee, and L. Zettlemoyer, “Deep contextualized word representations,” in _Proceedings of the 2018 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies, Volume 1 (Long Papers)_, vol. 1, 2018, pp. 2227–2237.
...
- \[5\] E. Arisoy, A. Sethy, B. Ramabhadran, and S. Chen, “Bidirectional recurrent neural network language models for automatic speech recognition,” in _2015 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_.   IEEE, 2015, pp. 5421–5425.
- \[6\] X. Chen, A. Ragni, X. Liu, and M. J. Gales, “Investigating bidirectional recurrent neural network language models for speech recognition.” in _INTERSPEECH_, 2017, pp. 269–273.
- \[7\] A. Graves and J. Schmidhuber, “Framewise phoneme classification with bidirectional lstm and other neural network architectures,” _Neural Networks_, vol. 18, no. 5-6, pp. 602–610, 2005.
...
- \[10\] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, Ł. Kaiser, and I. Polosukhin, “Attention is all you need,” in _Advances in Neural Information Processing Systems_, 2017, pp. 5998–6008.
- \[11\] M. Peters, M. Neumann, L. Zettlemoyer, and W.-t. Yih, “Dissecting contextual word embeddings: Architecture and representation,” in _Proceedings of the 2018 Conference on Empirical Methods in Natural Language Processing_, 2018, pp. 1499–1509.
- \[12\] G. Tang, M. Müller, A. Rios, and R. Sennrich, “Why self-attention? a targeted evaluation of neural machine translation architectures,” in _Proceedings of the 2018 Conference on Empirical Methods in Natural Language Processing_, 2018, pp. 4263–4272.
- \[13\] W. L. Taylor, ““cloze procedure”: A new tool for measuring readability,” _Journalism Bulletin_, vol. 30, no. 4, pp. 415–433, 1953.
- \[14\]
- \[15\] S. Watanabe, T. Hori, S. Karita, T. Hayashi, J. Nishitoba, Y. Unno, N.-E. Y. Soplin, J. Heymann, M. Wiesner, N. Chen _et al._, “Espnet: End-to-end speech processing toolkit,” _Proc. Interspeech 2018_, pp. 2207–2211, 2018.
- \[16\] J. K. Chorowski, D. Bahdanau, D. Serdyuk, K. Cho, and Y. Bengio, “Attention-based models for speech recognition,” in _Advances in neural information processing systems_, 2015, pp. 577–585.
...
- \[18\] M. D. Zeiler, “Adadelta: an adaptive learning rate method,” _arXiv preprint arXiv:1212.5701_, 2012.
- \[19\] D. Hendrycks and K. Gimpel, “Bridging nonlinearities and stochastic regularizers with gaussian error linear units,” _arXiv preprint arXiv:1606.08415_, 2016.
- \[20\] A. Radford, K. Narasimhan, T. Salimans, and I. Sutskever, “Improving language understanding by generative pre-training,” _URL https://s3-us-west-2. amazonaws. com/openai-assets/research-covers/languageunsupervised/language understanding paper. pdf_, 2018.
