...
arxiv_id: "1907.08293"
title:
  Investigating Target Set Reduction for End-to-End Speech Recognition of Hindi-English
  Code-Switching Data
authors:
  - Kunal Dhawan
  - Ganji Sreeram
...
- 1.  More than double expansion in the target set.
- 2.  Enhanced confusion among the target labels.
- 3.  Requirement of more data for reliable modelling.
- 4.  Weakening of attention mechanism, if employed.
