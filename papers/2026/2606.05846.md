...
arxiv_id: "2606.05846"
title:
  "Towards Truly Multilingual ASR: Generalizing Code-Switching ASR to Unseen
  Language Pairs"
authors:
  - Gio Paik
  - Hyunseo Shin
...
1.  1.  We systematically investigate whether CS-ASR capabilities learned from specific language pairs can generalize to unseen language pairs.
2.  2.  We show the limitations of directly applying existing model merging and domain generalization methods to CS-ASR.
3.  3.  We construct the first Korean-Japanese and Korean-German CS speech evaluation datasets, and will open-source the Korean-Japanese dataset.
