...
## References
- Ahmed and Tan (2012) Basem H.A. Ahmed and Tien-Ping Tan. 2012. [Automatic speech recognition of code switching speech using 1-best rescoring](https://doi.org/10.1109/IALP.2012.28). In *2012 International Conference on Asian Language Processing*, pages 137–140.
...
- Barnard et al. (2014) Etienne Barnard, Marelie H Davel, Charl van Heerden, Febe De Wet, and Jaco Badenhorst. 2014. The NCHLT speech corpus of the South African languages. In *4th Workshop on Spoken Language Technologies for Under-resourced Languages (SLTU 2014)*, pages 194–200.
- Biswas et al. (2022) Astik Biswas, Emre Yılmaz, Ewald van der Westhuizen, Febe de Wet, and Thomas Niesler. 2022. [Code-switched automatic speech recognition in five south african languages](https://doi.org/https://doi.org/10.1016/j.csl.2021.101262). *Computer Speech & Language*, 71:101262.
...
- Heafield (2011) Kenneth Heafield. 2011. [KenLM: Faster and smaller language model queries](https://www.aclweb.org/anthology/W11-2123). In *Proceedings of the Sixth Workshop on Statistical Machine Translation*, pages 187–197, Edinburgh, Scotland. Association for Computational Linguistics.
- Indra Winata et al. (2018) Genta Indra Winata, Andrea Madotto, Chien-Sheng Wu, and Pascale Fung. 2018. Towards end-to-end automatic code-switching speech recognition. *arXiv e-prints*, pages arXiv–1810.
- Li et al. (2019a) Ke Li, Jinyu Li, Guoli Ye, Rui Zhao, and Yifan Gong. 2019a. [Towards code-switching asr for end-to-end ctc models](https://doi.org/10.1109/ICASSP.2019.8683223). In *ICASSP 2019 - 2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 6076–6080.
- Li et al. (2019b) Ke Li, Jinyu Li, Guoli Ye, Rui Zhao, and Yifan Gong. 2019b. [Towards code-switching asr for end-to-end ctc models](https://doi.org/10.1109/ICASSP.2019.8683223). In *ICASSP 2019 - 2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 6076–6080.
- Luo et al. (2018) Ne Luo, Dongwei Jiang, Shuaijiang Zhao, Caixia Gong, Wei Zou, and Xiangang Li. 2018. Towards end-to-end code-switching speech recognition. *arXiv preprint arXiv:1810.13091*.
- Lyu et al. (2006) Daucheng Lyu, Ren yuan Lyu, Yuang chin Chiang, and Chun nan Hsu. 2006. [Speech recognition on code-switching among the chinese dialects](https://doi.org/10.1109/ICASSP.2006.1660218). In *2006 IEEE International Conference on Acoustics Speech and Signal Processing Proceedings*, volume 1, pages I–I.
- Myers-Scotton (2017) Carol Myers-Scotton. 2017. Code-switching. *The handbook of sociolinguistics*, pages 217–237.
...
- Rallabandi et al. (2018) SaiKrishna Rallabandi, Sunayana Sitaram, and Alan W Black. 2018. [Automatic detection of code-switching style from acoustics](https://doi.org/10.18653/v1/W18-3209). In *Proceedings of the Third Workshop on Computational Approaches to Linguistic Code-Switching*, pages 76–81, Melbourne, Australia. Association for Computational Linguistics.
- Song et al. (2022) Tongtong Song, Qiang Xu, Meng Ge, Longbiao Wang, Hao Shi, Yongjie Lv, Yuqin Lin, and Jianwu Dang. 2022. Language-specific characteristic assistance for code-switching speech recognition. *Interspeech 2022*.
- Wang et al. (2019) Qinyi Wang, Emre Yılmaz, Adem Derinel, and Haizhou Li. 2019. Code-switching detection using asr-generated language posteriors. *Proc. Interspeech 2019*, pages 3740–3744.
- Winata et al. (2018) Genta Indra Winata, Andrea Madotto, Chien-Sheng Wu, and Pascale Fung. 2018. Towards end-to-end automatic code-switching speech recognition. *arXiv preprint arXiv:1810.12620*.
- Yılmaz et al. (2016) Emre Yılmaz, Henk van den Heuvel, and David van Leeuwen. 2016. Code-switching detection using multilingual dnns. In *2016 IEEE Spoken Language Technology Workshop (SLT)*, pages 610–616. IEEE.
- Zeng et al. (2019) Zhiping Zeng, Yerbolat Khassanov, Haihua Xu Van Tung Pham, Eng Siong Chng, and Haizhou Li. 2019. On the end-to-end solution to mandarin-english code-switching speech recognition. *Interspeech 2019*.
- Zhang et al. (2022) Shuai Zhang, Jiangyan Yi, Zhengkun Tian, Jianhua Tao, Yu Ting Yeung, and Liqun Deng. 2022. Reducing multilingual context confusion for end-to-end codeswitching automatic speech recognition. In *Proc. Interspeech*, pages 3894–3898.
