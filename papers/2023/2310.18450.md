...
1.  1.
    A data augmentation strategy using the mixup of hidden representations for low-resource speech recognition ¹¹1[https://github.com/jiamin1013/mixrep-espnet](https://github.com/jiamin1013/mixrep-espnet)
2.  2.
    Highlight of the complementary regularization on both time and frequency (feature) dimensions for mixup methods
3.  3.
    Investigation of other techniques, e.g. SpecAugment \[26\] and MixSpeech \[27\], and their comparison to MixRep
...
- \[4\] T. N. Sainath, B. Kingsbury, A.-r. Mohamed, G. E. Dahl, G. Saon, H. Soltau, T. Beran, A. Y. Aravkin, and B. Ramabhadran, \`\`Improvements to deep convolutional neural networks for lvcsr,'' in *IEEE ASRU'13*, pp. 315–320.
...
- \[32\] L. D. Pham, I. McLoughlin, H. Phan, and R. Palaniappan, \`\`A robust framework for acoustic scene classification.'' in *INTERSPEECH*, 2019, pp. 3634–3638.
...
- \[34\] I. Medennikov, Y. Y. Khokhlov, A. Romanenko, D. Popov, N. A. Tomashenko, I. Sorokin, and A. Zatvornitskiy, \`\`An investigation of mixup training strategies for acoustic models in asr.'' in *Interspeech*, 2018, pp. 2903–2907.
