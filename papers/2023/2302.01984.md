...
1.  1.
    To repurpose ASR-optimized transformer models to perform reliable IU boundary detection.
2.  2.
    To discover the role of sound versus syntax in such models via replication over diminished versions of the finetuning set.
3.  3.
    To test the robustness of prosodic boundary predictions through harmonic frequency filtering and evaluation of out-of-distribution speech data.
