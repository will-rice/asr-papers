...
- Agrawal et al. (2020) Bhuvan Agrawal, Markus Müller, Martin Radfar, Samridhi Choudhary, Athanasios Mouchtaris, and Siegfried Kunzmann. 2020. Tie your embeddings down: Cross-modal latent spaces for end-to-end spoken language understanding. _arXiv preprint arXiv:2011.09044_.
...
- Bent and Holt (2017) Tessa Bent and Rachael F Holt. 2017. Representation of speech variability. _Wiley Interdisciplinary Reviews: Cognitive Science_, 8(4):e1434.
- Cai et al. (2016) Mengya Cai, Yingzi Lin, Bin Han, Changjun Liu, and Wenjun Zhang. 2016. On a simple and efficient approach to probability distribution function aggregation. _IEEE Transactions on Systems, Man, and Cybernetics: Systems_, 47(9):2444–2453.
...
- Coulombe (2018) Claude Coulombe. 2018. Text data augmentation made simple by leveraging nlp cloud apis. _arXiv preprint arXiv:1812.04718_.
...
- Huang et al. (2020) Yinghui Huang, Hong-Kwang Kuo, Samuel Thomas, Zvi Kons, Kartik Audhkhasi, Brian Kingsbury, Ron Hoory, and Michael Picheny. 2020. Leveraging unpaired text data for training end-to-end speech-to-intent systems. In _ICASSP 2020-2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 7984–7988. IEEE.
- Këpuska and Bohouta (2017) Veton Këpuska and Gamal Bohouta. 2017. Comparing speech recognition systems (microsoft api, google api and cmu sphinx). _Int. J. Eng. Res. Appl_, 7(03):20–24.
- Kim et al. (2017) Young-Bum Kim, Sungjin Lee, and Karl Stratos. 2017. Onenet: Joint domain, intent, slot prediction for spoken language understanding. In _2017 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)_, pages 547–553. IEEE.
...
- Masumura et al. (2018) Ryo Masumura, Yusuke Ijima, Taichi Asami, Hirokazu Masataki, and Ryuichiro Higashinaka. 2018. Neural confnet classification: Fully neural network based spoken utterance classification using word confusion networks. In _2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 6039–6043. IEEE.
- Saade et al. (2019) Alaa Saade, Joseph Dureau, David Leroy, Francesco Caltagirone, Alice Coucke, Adrien Ball, Clément Doumouro, Thibaut Lavril, Alexandre Caulier, Théodore Bluche, et al. 2019. Spoken language understanding on the edge. In _2019 Fifth Workshop on Energy Efficient Machine Learning and Cognitive Computing-NeurIPS Edition (EMC2-NIPS)_, pages 57–61. IEEE.
- Sak et al. (2014) Haşim Sak, Andrew Senior, and Françoise Beaufays. 2014. Long short-term memory based recurrent neural network architectures for large vocabulary speech recognition. _arXiv preprint arXiv:1402.1128_.
...
- Simonnet et al. (2018) Edwin Simonnet, Sahar Ghannay, Nathalie Camelin, and Yannick Estève. 2018. Simulating asr errors for training slu systems. In _Proceedings of the Eleventh International Conference on Language Resources and Evaluation (LREC 2018)_.
- Simonnet et al. (2017) Edwin Simonnet, Sahar Ghannay, Nathalie Camelin, Yannick Estève, and Renato De Mori. 2017. Asr error management for improving spoken language understanding. _arXiv preprint arXiv:1705.09515_.
- WIT (2021) WIT. 2021. [Build natural language experiences](http://www.wit.ai). Accessed on 13-August-2021\].
- Zhu et al. (2018) Su Zhu, Ouyu Lan, and Kai Yu. 2018. Robust spoken language understanding with unsupervised asr-error adaptation. In _2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 6179–6183. IEEE.
