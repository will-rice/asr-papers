...
arxiv_id: "2311.18739"
title:
  "Mavericks at NADI 2023 Shared Task: Unravelling Regional Nuances through Dialect
...
- Abdul-Mageed et al. (2023) Muhammad Abdul-Mageed, AbdelRahim Elmadany, Chiyu Zhang, ElMoatez Billah Nagoudi, Houda Bouamor, and Nizar Habash. 2023. NADI 2023: The Fourth Nuanced Arabic Dialect Identification Shared Task. In _Proceedings of The First Arabic Natural Language Processing Conference (ArabicNLP 2023)_.
...
- Al-Ayyoub et al. (2018) Mahmoud Al-Ayyoub, Aya Nuseir, Kholoud Alsmearat, Yaser Jararweh, and Brij Gupta. 2018. [Deep learning for arabic nlp: A survey](https://doi.org/https://doi.org/10.1016/j.jocs.2017.11.011). _Journal of Computational Science_, 26:522–531.
...
- AlShenaifi and Azmi (2022) Nouf AlShenaifi and Aqil Azmi. 2022. [Arabic dialect identification using machine learning and transformer-based models: Submission to the NADI 2022 shared task](https://doi.org/10.18653/v1/2022.wanlp-1.50). In _Proceedings of the The Seventh Arabic Natural Language Processing Workshop (WANLP)_, pages 464–467, Abu Dhabi, United Arab Emirates (Hybrid). Association for Computational Linguistics.
...
- El Mekki et al. (2020) Abdellah El Mekki, Ahmed Alami, Hamza Alami, Ahmed Khoumsi, and Ismail Berrada. 2020. [Weighted combination of BERT and n-GRAM features for nuanced Arabic dialect identification](https://aclanthology.org/2020.wanlp-1.27). In _Proceedings of the Fifth Arabic Natural Language Processing Workshop_, pages 268–274, Barcelona, Spain (Online). Association for Computational Linguistics.
- Gaanoun and Benelallam (2020) Kamel Gaanoun and Imade Benelallam. 2020. [Arabic dialect identification: An Arabic-BERT model with data augmentation and ensembling strategy](https://aclanthology.org/2020.wanlp-1.28). In _Proceedings of the Fifth Arabic Natural Language Processing Workshop_, pages 275–281, Barcelona, Spain (Online). Association for Computational Linguistics.
...
- Mansour et al. (2020) Moataz Mansour, Moustafa Tohamy, Zeyad Ezzat, and Marwan Torki. 2020. [Arabic dialect identification using BERT fine-tuning](https://aclanthology.org/2020.wanlp-1.33). In _Proceedings of the Fifth Arabic Natural Language Processing Workshop_, pages 308–312, Barcelona, Spain (Online). Association for Computational Linguistics.
- Oumar and Mrini (2022) Ahmed Oumar and Khalil Mrini. 2022. [Ahmed and khalil at NADI 2022: Transfer learning and addressing class imbalance for Arabic dialect identification and sentiment analysis](https://doi.org/10.18653/v1/2022.wanlp-1.46). In _Proceedings of the The Seventh Arabic Natural Language Processing Workshop (WANLP)_, pages 442–446, Abu Dhabi, United Arab Emirates (Hybrid). Association for Computational Linguistics.
...
- Tahssin et al. (2020) Rawan Tahssin, Youssef Kishk, and Marwan Torki. 2020. [Identifying nuanced dialect for Arabic tweets with deep learning and reverse translation corpus extension system](https://aclanthology.org/2020.wanlp-1.30). In _Proceedings of the Fifth Arabic Natural Language Processing Workshop_, pages 288–294, Barcelona, Spain (Online). Association for Computational Linguistics.
