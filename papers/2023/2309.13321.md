...
Figure 1: ONNX-to-Hardware design flow for the generation of adaptive neural-network accelerators on FPGAs. The manual steps needed in \[1\] (grey lines) have been fully automated with the newly engineered *HLS Writer*.
