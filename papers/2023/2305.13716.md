...
## References
- \[1\] Y. Wu, C. Li, S. Yang, Z. Wu, and Y. Qian, \`\`Audio-visual multi-talker speech recognition in a cocktail party,'' in *Proc. Interspeech 2021*.   ISCA, 2021, pp. 3021–3025.
- \[2\] M. Yang, N. Kanda, X. Wang, J. Wu, S. Sivasankaran, Z. Chen, J. Li, and T. Yoshioka, \`\`Simulating realistic speech overlaps improves multi-talker ASR,'' *CoRR*, vol. abs/2210.15715, 2022.
- \[3\] H. Taherian, K. Tan, and D. Wang, \`\`Location-based training for multi-channel talker-independent speaker separation,'' in *Proc. ICASSP*.   IEEE, 2022, pp. 696–700.
- \[4\] A. S. Subramanian, C. Weng, S. Watanabe, M. Yu, and D. Yu, \`\`Deep learning based multi-source localization with source splitting and its effectiveness in multi-talker speech recognition,'' *Comput. Speech Lang.*, vol. 75, p. 101360, 2022.
- \[5\] F. Yu, S. Zhang, P. Guo, Y. Liang, Z. Du, Y. Lin, and L. Xie, \`\`MFCCA:multi-frame cross-channel attention for multi-speaker ASR in multi-party meeting scenario,'' in *Proc. SLT*.   IEEE, 2022, pp. 144–151.
- \[6\] J. G. Fiscus, N. Radde, J. S. Garofolo, A. Le, J. Ajot, and C. Laprun, \`\`The rich transcription 2005 spring meeting recognition evaluation,'' in *Proc. MLMI*.   Springer, 2005, pp. 369–389.
- \[7\] J. G. Fiscus, J. Ajot, M. Michel, and J. S. Garofolo, \`\`The rich transcription 2006 spring meeting recognition evaluation,'' in *Proc. MLMI*.   Springer, 2006, pp. 309–322.
- \[8\] J. G. Fiscus, J. Ajot, and J. S. Garofolo, \`\`The rich transcription 2007 meeting recognition evaluation,'' in *Proc. MTPH*.   Springer, 2007, pp. 373–389.
- \[9\] S. Watanabe, M. Mandel, J. Barker *et al.*, \`\`CHiME-6 Challenge: Tackling Multispeaker Speech Recognition for Unsegmented Recordings,'' in *Proc. CHiME*, 2020, pp. 1–7.
- \[10\] F. Yu, S. Zhang, Y. Fu, L. Xie, S. Zheng, Z. Du *et al.*, \`\`M2MeT: The ICASSP 2022 multi-channel multi-party meeting transcription challenge,'' in *Proc. ICASSP*.   IEEE, 2022.
- \[11\] H. Chen, H. Zhou, J. Du, C.-H. Lee, J. Chen, S. Watanabe, S. M. Siniscalchi, O. Scharenborg, D.-Y. Liu, B.-C. Yin, J. Pan, J.-Q. Gao, and C. Liu, \`\`The first multimodal information based speech processing (MISP) challenge: Data, tasks, baselines and results,'' in *Proc. ICASSP*.   IEEE, 2022, pp. 9266–9270.
- \[12\] J. Barker, S. Watanabe, E. Vincent, and J. Trmal, \`\`The fifth 'CHiME' speech separation and recognition challenge: Dataset, task and baselines,'' in *Proc. INTERSPEECH*.   ISCA, 2018, pp. 1561–1565.
- \[13\] I. McCowan, J. Carletta, W. Kraaij, S. Ashby, S. Bourban, M. Flynn *et al.*, \`\`The AMI meeting corpus,'' in *Proc. ICMT*, vol. 88, 2005, p. 100.
- \[14\] Z. Chen, T. Yoshioka, L. Lu, T. Zhou, Z. Meng, Y. Luo, J. Wu, X. Xiao, and J. Li, \`\`Continuous speech separation: Dataset and analysis,'' in *Proc. ICASSP*.   IEEE, 2020, pp. 7284–7288.
- \[15\] Y. Fu, L. Cheng, S. Lv, Y. Jv, Y. Kong, Z. Chen, Y. Hu *et al.*, \`\`AISHELL-4: An open source dataset for speech enhancement, separation, recognition and speaker diarization in conference scenario,'' in *Proc. INTERSPEECH*.   ISCA, 2021, pp. 3665–3669.
- \[16\] F. Yu, S. Zhang, P. Guo, Y. Fu, Z. Du, S. Zheng, L. Xie *et al.*, \`\`Summary on the ICASSP 2022 multi-channel multi-party meeting transcription grand challenge,'' in *Proc. ICASSP*.   IEEE, 2022.
- \[17\] J. Wu, Z. Chen, J. Li, T. Yoshioka, Z. Tan, E. Lin, Y. Luo, and L. Xie, \`\`An end-to-end architecture of online multi-channel speech separation,'' in *Proc. Interspeech*.   ISCA, 2020, pp. 81–85.
- \[18\] S. Chen, Y. Wu, Z. Chen, J. Wu, J. Li, T. Yoshioka, C. Wang, S. Liu, and M. Zhou, \`\`Continuous speech separation with conformer,'' in *Proc. ICASSP*.   IEEE, 2021, pp. 5749–5753.
- \[19\] D. Yu, M. Kolbæk, Z. Tan, and J. Jensen, \`\`Permutation invariant training of deep models for speaker-independent multi-talker speech separation,'' in *Proc. ICASSP*.   IEEE, 2017, pp. 241–245.
- \[20\] Z. Wang and D. Wang, \`\`Count and separate: Incorporating speaker counting for continuous speaker separation,'' in *Proc. ICASSP*.   IEEE, 2021, pp. 11–15.
- \[21\] D. Yu, X. Chang, and Y. Qian, \`\`Recognizing multi-talker speech with permutation invariant training,'' in *Proc. Interspeech*.   ISCA, 2017, pp. 2456–2460.
- \[22\] Y. Qian, X. Chang, and D. Yu, \`\`Single-channel multi-talker speech recognition with permutation invariant training,'' *Speech Commun.*, pp. 1–11, 2018.
- \[23\] T. von Neumann, K. Kinoshita, C. Böddeker, M. Delcroix, and R. Haeb-Umbach, \`\`Graph-pit: Generalized permutation invariant training for continuous separation of arbitrary numbers of speakers,'' in *Proc. Interspeech*.   ISCA, 2021, pp. 3490–3494.
- \[24\] H. Seki, T. Hori, S. Watanabe, J. L. Roux, and J. R. Hershey, \`\`A purely end-to-end system for multi-speaker speech recognition,'' in *Proc. ACL*.   ACL, 2018, pp. 2620–2630.
- \[25\] X. Chang, Y. Qian, K. Yu, and S. Watanabe, \`\`End-to-end monaural multi-speaker ASR system without pretraining,'' in *proc. ICASSP*.   IEEE, 2019, pp. 6256–6260.
- \[26\] X. Chang, W. Zhang, Y. Qian, J. L. Roux, and S. Watanabe, \`\`Mimo-speech: End-to-end multi-channel multi-speaker speech recognition,'' in *Proc. ASRU*.   IEEE, 2019, pp. 237–244.
- \[27\] J. Shi, J. Xu, Y. Fujita, S. Watanabe, and B. Xu, \`\`Speaker-conditional chain model for speech separation and extraction,'' in *Proc. Interspeech*.   ISCA, 2020, pp. 2707–2711.
- \[28\] J. Shi, X. Chang, P. Guo, S. Watanabe, Y. Fujita, J. Xu, B. Xu, and L. Xie, \`\`Sequence to multi-sequence learning via conditional chain mapping for mixture signals,'' in *Proc. NIPS*, 2020.
- \[29\] P. Guo, X. Chang, S. Watanabe, and L. Xie, \`\`Multi-speaker ASR combining non-autoregressive conformer CTC and conditional speaker chain,'' in *Proc. Interspeech*.   ISCA, 2021, pp. 3720–3724.
- \[30\] N. Kanda, Y. Gaur, X. Wang, Z. Meng, and T. Yoshioka, \`\`Serialized output training for end-to-end overlapped speech recognition,'' in *Proc. Interspeech*.   ISCA, 2020, pp. 2797–2801.
- \[31\] N. Kanda, J. Wu, Y. Wu, X. Xiao, Z. Meng, X. Wang, Y. Gaur, Z. Chen, J. Li, and T. Yoshioka, \`\`Streaming multi-talker ASR with token-level serialized output training,'' in *Proc. Interspeech*.   ISCA, 2022, pp. 3774–3778.
- \[32\] B. Zhang, H. Lv, P. Guo, Q. Shao, C. Yang, L. Xie, X. Xu, H. Bu, X. Chen, C. Zeng, D. Wu, and Z. Peng, \`\`WENETSPEECH: A 10000+ hours multi-domain mandarin corpus for speech recognition,'' in *Proc. ICASSP*.   IEEE, 2022, pp. 6182–6186.
- \[33\] B. Yan, S. Dalmia, Y. Higuchi, G. Neubig, F. Metze, A. W. Black, and S. Watanabe, \`\`CTC alignments improve autoregressive translation,'' in *arXiv preprint arXiv:2210.05200*, 2022.
- \[34\] W. Huang and J. Feng, \`\`Differential beamforming for uniform circular array with directional microphones.'' in *Proc. INTERSPEECH*.   ISCA, 2020, pp. 71–75.
- \[35\] S. Zheng, W. Huang, X. Wang, H. Suo, J. Feng, and Z. Yan, \`\`A real-time speaker diarization system based on spatial spectrum,'' in *Proc. ICASSP*.   IEEE, 2021, pp. 7208–7212.
- \[36\] S. Watanabe, T. Hori, S. Karita, T. Hayashi, J. Nishitoba, Y. Unno, N. Enrique Yalta Soplin, J. Heymann, M. Wiesner, N. Chen, A. Renduchintala, and T. Ochiai, \`\`ESPnet: End-to-end speech processing toolkit,'' in *Proc. Interspeech*, 2018, pp. 2207–2211.
