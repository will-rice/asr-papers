...
1.  1.
    Our best system achieves state-of-the-art performance on the How2 summarization task.
2.  2.
    We confirm that external TSum data enables E2E SSum model improvements with TTS technology.
3.  3.
    We propose a phoneme-based data augmentation method, resulting in lower computational costs than TTS-based one.
4.  4.
    We suggest that filtering the evaluation set of the How2 dataset is important for assessing the quality of summarization abilities of models more reasonably.
