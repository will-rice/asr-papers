...
- \[8\] A. Yazgan and M. Saraçlar, \`\`Hybrid language models for out of vocabulary word detection in large vocabulary conversational speech recognition,'' in *Proc. ICASSP*, vol. 1, 2004, pp. I–745.
...
- \[17\] J. Pylkkönen, A. Ukkonen, J. Kilpikoski, S. Tamminen, and H. Heikinheimo, \`\`Fast text-only domain adaptation of rnn-transducer prediction network,'' in *Proc. Interspeech*, 2021, pp. 1882–1886.
