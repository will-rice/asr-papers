...
url: https://arxiv.org/abs/1808.00521
source: arxiv
doi: null
arxiv_id: '1808.00521'
categories:
...
- \[21\] E. Yılmaz, H. Van den Heuvel, and D. A. Van Leeuwen, “Acoustic and textual data augmentation for improved ASR of code-switching speech,” in _Accepted for publication, INTERSPEECH_, Sept. 2018.
- \[22\] V. Peddinti, Y. Wang, D. Povey, and S. Khudanpur, “Low latency acoustic modeling using temporal convolution and LSTMs,” _IEEE Signal Processing Letters_, vol. 25, no. 3, pp. 373–377, March 2018.
- \[23\] E. Yılmaz, M. Andringa, S. Kingma, F. Van der Kuip, H. Van de Velde, F. Kampstra, J. Algra, H. Van den Heuvel, and D. Van Leeuwen, “A longitudinal bilingual Frisian-Dutch radio broadcast database designed for code-switching research,” in _Proc. LREC_, 2016, pp. 4666–4669.
- \[24\] I. Sutskever, J. Martens, and G. Hinton, “Generating text with recurrent neural networks,” in _Proc. ICML-11_, June 2011, pp. 1017–1024.
...
- \[26\] R. v. Bezooijen and J. Ytsma, “Accents of Dutch: personality impression, divergence, and identifiability,” _Belgian Journal of Linguistics_, pp. 105––129, 1999.
- \[27\] N. Oostdijk, “The spoken Dutch corpus: Overview and first evaluation,” in _Proc. LREC_, 2000, pp. 886–894.
- \[28\] M. Graciarena, L. Ferrer, and V. Mitra, “The SRI System for the NIST OpenSAD 2015 speech activity detection evaluation,” in _Proc. INTERSPEECH_, 2016, pp. 3673–3677.
- \[29\] D. Povey, A. Ghoshal, G. Boulianne, L. Burget, O. Glembek, N. Goel, M. Hannemann, P. Motlicek, Y. Qian, P. Schwarz, J. Silovsky, G. Stemmer, and K. Vesely, “The Kaldi speech recognition toolkit,” in _Proc. ASRU_, Dec. 2011.
- \[30\] D. Povey, V. Peddinti, D. Galvez, P. Ghahremani, V. Manohar, X. Na, Y. Wang, and S. Khudanpur, “Purely sequence-trained neural networks for ASR based on lattice-free MMI,” in _Proc. INTERSPEECH_, 2016, pp. 2751–2755.
- \[31\] G. Saon, H. Soltau, D. Nahamoo, and M. Picheny, “Speaker adaptation of neural network acoustic models using i-vectors,” in _Proc. ASRU_, Dec 2013, pp. 55–59.
- \[32\] T. Mikolov, M. Karafiát, L. Burget, J. Cernocký, and S. Khudanpur, “Recurrent neural network based language model,” in _Proc. INTERSPEECH_, 2010, pp. 1045–1048.
- \[33\] J. Chung, C. Gulcehre, and Y. Kyung Hyun Cho, Bengio, “Empirical evaluation of gated recurrent neural networks on sequence modeling,” _arXiv:1412.3555_, 2014.
- \[34\] X. Chen, X. Liu, M. J. F. Gales, and P. C. Woodland, “Recurrent neural network language model training with noise contrastive estimation for speech recognition,” in _Proc. ICASSP_, April 2015, pp. 5411–5415.
- \[35\] M. Sundermeyer, R. Schlüter, and H. Ney, “LSTM neural networks for language modeling,” in _Proc. INTERSPEECH_, 2012, pp. 194–197.
- \[36\] M. Davel and E. Barnard, “Bootstrapping for language resource generation,” in _Pattern Recognition Association of South Africa_, 2003, pp. 97–100.
- \[37\] S. R. Maskey, A. B. Black, and L. M. Tomokiyo, “Bootstrapping phonetic lexicons for new languages,” in _Proc. ICLSP_, 2004, pp. 69–72.
- \[38\] J. R. Novak, N. Minematsu, and K. Hirose, “Phonetisaurus: Exploring grapheme-to-phoneme conversion with joint n-gram models in the WFST framework,” _Natural Language Engineering_, pp. 1–32, 9 2015.
- \[39\] A. Martin, G. Doddington, T. Kamm, M. Ordowski, and M. Przybocki, “The DET curve in assessment of detection task performance,” in _Proc. Eurospeech_, Sep. 1997, pp. 1895–1898.
