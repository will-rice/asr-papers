...
1.  1.  Pretrain a BERT using a large-scale text dataset.
2.  2.  fine-tune a BERT-LM on the transcriptions of the ASR training dataset, as described in Section 3.1,
3.  3.  fine-tune a BERT-ASR using both text and speech data of the ASR training dataset.
