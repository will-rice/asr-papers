---
arxiv_id: '1506.01911'
title: 'Beyond Temporal Pooling: Recurrence and Temporal Convolutions for Gesture
...
Montalbano gesture recognition dataset results compared to previous work. *Crop*: the cropping of specific areas in the video using the skeletal information. *Depth*: the usage of depth-maps. *Pose*: the usage of the skeletal stream as features. Note that even when we do not use depth images, we still achieve better results.\
