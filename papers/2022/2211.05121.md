...
- •
  _In-domain adaptation_, where one of the training corpora is in the same domain with the target;
- •
  _Out-of-domain adaptation_, none of the training corpora being in the same domain with the target.
