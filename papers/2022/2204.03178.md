...
- \[2\] S. Watanabe, T. Hori, S. Karita, T. Hayashi, J. Nishitoba, Y. Unno, N. E. Y. Soplin, J. Heymann, M. Wiesner, N. Chen *et al.*, “Espnet: End-to-end speech processing toolkit,” *arXiv preprint arXiv:1804.00015*, 2018.
- \[3\] B. Zhang, D. Wu, C. Yang, X. Chen, Z. Peng, X. Wang, Z. Yao, X. Wang, F. Yu, L. Xie *et al.*, “Wenet: Production first and production ready end-to-end speech recognition toolkit,” *arXiv e-prints*, pp. arXiv–2102, 2021.
- \[4\] T. Hori, S. Watanabe, Y. Zhang, and W. Chan, “Advances in joint ctc-attention based end-to-end speech recognition with a deep CNN encoder and RNN-LM,” *CoRR*, vol. abs/1706.02737, 2017. \[Online\]. Available: http://arxiv.org/abs/1706.02737
- \[5\] L. Wu, T. Li, L. Wang, and Y. Yan, “Improving hybrid ctc/attention architecture with time-restricted self-attention ctc for end-to-end speech recognition,” *Applied Sciences*, vol. 9, no. 21, p. 4639, 2019.
...
- \[7\] T. Hori, S. Watanabe, and J. R. Hershey, “Joint ctc/attention decoding for end-to-end speech recognition,” in *Proceedings of the 55th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, 2017, pp. 518–529.
- \[8\] W. Chan, D. Park, C. Lee, Y. Zhang, Q. Le, and M. Norouzi, “Speechstew: Simply mix all available speech recognition data to train one large neural network,” *arXiv preprint arXiv:2104.02133*, 2021.
...
- \[13\] S. Gross, M. Ranzato, and A. Szlam, “Hard mixtures of experts for large scale weakly supervised vision,” in *Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition*, 2017, pp. 6865–6873.
- \[14\] K. Ahmed, M. H. Baig, and L. Torresani, “Network of experts for large-scale image categorization,” in *European Conference on Computer Vision*.   Springer, 2016, pp. 516–532.
- \[15\] X. Wang, F. Yu, L. Dunlap, Y.-A. Ma, R. Wang, A. Mirhoseini, T. Darrell, and J. E. Gonzalez, “Deep mixture of experts via shallow embedding,” in *Uncertainty in Artificial Intelligence*.   PMLR, 2020, pp. 552–562.
- \[16\] S. Cai, Y. Shu, and W. Wang, “Dynamic routing networks,” in *Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision*, 2021, pp. 3588–3597.
- \[17\] Z. You, S. Feng, D. Su, and D. Yu, “Speechmoe: Scaling to large acoustic models with dynamic routing mixture of experts,” *arXiv preprint arXiv:2105.03036*, 2021.
- \[18\] ——, “Speechmoe2: Mixture-of-experts model with improved routing,” *arXiv preprint arXiv:2111.11831*, 2021.
