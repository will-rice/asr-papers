...
$`\begin{aligned}
{Q_{\text{MMI}}\hspace{0pt}{(t,u_{1}^{k})}} & {= {{{Q_{\text{MMI}}\hspace{0pt}{({t - 1},u_{1}^{k})}} \cdot q_{\text{seq}}}\hspace{0pt}{(\left. \epsilon \middle| {u_{1}^{k},h_{t}} \right.)}}} \\
 + & {\sum\limits_{u_{0}}{{{Q_{\text{MMI}}\hspace{0pt}{({t - 1},u_{0}^{k - 1})}} \cdot q_{\text{seq}}}\hspace{0pt}{(\left. u_{k} \middle| {u_{0}^{k - 1},h_{t}} \right.)}}}
\end{aligned}`$
