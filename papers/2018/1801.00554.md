...
population $`\longleftarrow`$ InitializePopulation(*$`\mathbf{x}`$*)
...
       scores $`\longleftarrow`$ ComputeFitness(*population*)
...
             child = Crossover(*$`p\hspace{0pt}a\hspace{0pt}r\hspace{0pt}e\hspace{0pt}n\hspace{0pt}t_{1}`$, $`p\hspace{0pt}a\hspace{0pt}r\hspace{0pt}e\hspace{0pt}n\hspace{0pt}t_{2}`$*)
...
      foreach *child of Next population* do Mutate(*$`c\hspace{0pt}h\hspace{0pt}i\hspace{0pt}l\hspace{0pt}d`$*)
...
return *$`\mathbf{x}_{a\hspace{0pt}d\hspace{0pt}v}`$*
