...
1.  1.
    DenseNet \[9\]: DenseNet with 13 dense connection blocks and 3 max-pooling steps with stride 2 on both time and frequency domain, trained with cross-entropy (CE) and sequence-discriminative training (SDT) criterion \[10\].
2.  2.
    BiLSTM \[11\]: 3 layers BiLSTM network trained with CE and SDT criterion.
3.  3.
    CLDNN \[12\]: CNN-BiLSTM-DNN structure trained with CE and SDT criterion.
...
- \[3\] A. Bérard, L. Besacier, A. C. Kocabiyikoglu, and O. Pietquin, “End-to-end automatic speech translation of audiobooks,” *arXiv preprint arXiv:1802.04200*, 2018.
