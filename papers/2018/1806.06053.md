...
- \[1\] A. Krizhevsky, I. Sutskever, and G. E. Hinton, “ImageNet classification with deep convolutional neural networks,” in _NIPS_, 2012.
...
- \[3\] K. He, X. Zhang, S. Ren, and J. Sun, “Deep residual learning for image recognition,” _arXiv preprint arXiv:1512.03385_, 2015.
...
- \[5\] J. S. Chung and A. Zisserman, “Lip reading in the wild,” in _Proc. ACCV_, 2016.
- \[6\] J. S. Chung, A. Senior, O. Vinyals, and A. Zisserman, “Lip reading sentences in the wild,” in _Proc. CVPR_, 2017.
- \[7\] I. Sutskever, O. Vinyals, and Q. Le, “Sequence to sequence learning with neural networks,” in _NIPS_, 2014.
- \[8\] K. Cho, B. van Merriënboer, Ç. Gülçehre, D. Bahdanau, F. Bougares, H. Schwenk, and Y. Bengio, “Learning phrase representations using rnn encoder–decoder for statistical machine translation,” in _EMNLP_, Oct 2014.
- \[9\] D. Bahdanau, K. Cho, and Y. Bengio, “Neural machine translation by jointly learning to align and translate,” _CoRR_, vol. abs/1409.0473, 2014.
- \[10\] A. Graves, S. Fernández, F. Gomez, and J. Schmidhuber, “Connectionist temporal classification: labelling unsegmented sequence data with recurrent neural networks,” in _Proc. ICML_.   ACM, 2006.
- \[11\] A. Graves, “Sequence transduction with recurrent neural networks,” _CoRR_, vol. abs/1211.3711, 2012.
...
- \[13\] J. S. Chung and A. Zisserman, “Learning to lip read words by watching videos,” _CVIU_, 2018.
...
- \[15\] J. S. Chung and A. Zisserman, “Lip reading in profile,” in _Proc. BMVC._, 2017.
- \[16\] T. Stafylakis and G. Tzimiropoulos, “Combining residual networks with lstms for lipreading,” in _Interspeech_, 2017.
- \[17\] S. Petridis, T. Stafylakis, P. Ma, F. Cai, G. Tzimiropoulos, and M. Pantic, “End-to-end audiovisual speech recognition,” _CoRR_, vol. abs/1802.06424, 2018.
- \[18\] S. Bai, J. Z. Kolter, and V. Koltun, “An empirical evaluation of generic convolutional and recurrent networks for sequence modeling,” _arXiv preprint arXiv:1803.01271_, 2018.
- \[19\] J. Gehring, M. Auli, D. Grangier, and Y. Dauphin, “A convolutional encoder model for neural machine translation,” in _ACL_, 2017.
- \[20\] J. Gehring, M. Auli, D. Grangier, D. Yarats, and Y. N. Dauphin, “Convolutional sequence to sequence learning,” in _ICML_, 2017.
- \[21\] N. Kalchbrenner, L. Espeholt, K. Simonyan, A. van den Oord, A. Graves, and K. Kavukcuoglu, “Neural machine translation in linear time,” _CoRR_, vol. abs/1610.10099, 2016.
- \[22\] A. van den Oord, S. Dieleman, H. Zen, K. Simonyan, O. Vinyals, A. Graves, N. Kalchbrenner, A. W. Senior, and K. Kavukcuoglu, “Wavenet: A generative model for raw audio,” in _ISCA Speech Synthesis Workshop_, 2016.
...
- \[24\] F. Chollet, “Xception: Deep learning with depthwise separable convolutions,” in _Proc. CVPR_, 2017.
- \[25\] Y. Wang, X. Deng, S. Pu, and Z. Huang, “Residual Convolutional CTC Networks for Automatic Speech Recognition,” _arXiv preprint arXiv:1702.07793_, 2017.
- \[26\] Y. Zhang, M. Pezeshki, P. Brakel, S. Zhang, C. Laurent, Y. Bengio, and A. C. Courville, “Towards end-to-end speech recognition with deep convolutional neural networks,” _CoRR_, vol. abs/1701.02720, 2017.
- \[27\] R. Collobert, C. Puhrsch, and G. Synnaeve, “Wav2letter: an end-to-end convnet-based speech recognition system,” _CoRR_, vol. abs/1609.03193, 2016.
- \[28\] V. Liptchinsky, G. Synnaeve, and R. Collobert, “Letter-based speech recognition with gated convnets,” _CoRR_, vol. abs/1712.09444, 2017.
- \[29\] N. Zeghidour, N. Usunier, I. Kokkinos, T. Schatz, G. Synnaeve, and E. Dupoux, “Learning filterbanks from raw speech for phone recognition,” _CoRR_, vol. abs/1711.01161, 2017.
- \[30\] C. Raffel, T. Luong, P. J. Liu, R. J. Weiss, and D. Eck, “Online and linear-time attention by enforcing monotonic alignments,” _CoRR_, vol. abs/1704.00784, 2017.
- \[31\] Y. Luo, C.-C. Chiu, G. Brain, N. Jaitly, and I. Sutskever, “Learning online alignments with continuous rewards policy gradient,” _arXiv preprint arXiv:1608.01281_, 2017.
- \[32\] S. Kim, M. L. Seltzer, J. Li, and R. Zhao, “Improved training for online end-to-end speech recognition systems,” _arXiv preprint arXiv:1711.02212_, 2017.
- \[33\] K. Hwang and W. Sung, “Online sequence training of recurrent neural networks with connectionist temporal classification,” _arXiv preprint arXiv:1511.06841_, 2017.
- \[34\] N. Jaitly, Q. V. Le, O. Vinyals, I. Sutskever, D. Sussillo, and S. Bengio, “An online sequence-to-sequence model using partial conditioning,” in _NIPS_, 2016.
- \[35\] A. Graves and N. Jaitly, “Towards end-to-end speech recognition with recurrent neural networks,” in _Proceedings of the 31st International Conference on International Conference on Machine Learning - Volume 32_, ser. ICML, 2014.
- \[36\] A. L. Maas, Z. Xie, D. Jurafsky, and A. Y. Ng, “Lexicon-free conversational speech recognition with neural networks,” in _Proceedings the North American Chapter of the Association for Computational Linguistics (NAACL)_, 2015.
- \[37\] A. Kannan, Y. Wu, P. Nguyen, T. N. Sainath, Z. Chen, and R. Prabhavalkar, “An analysis of incorporating an external language model into a sequence-to-sequence model,” _arXiv preprint arXiv:1712.01996_, 2017.
- \[38\] N. Srivastava, G. Hinton, A. Krizhevsky, I. Sutskever, and R. Salakhutdinov, “Dropout: A simple way to prevent neural networks from overfitting,” _The Journal of Machine Learning Research_, 2014.
- \[39\] D. P. Kingma and J. Ba, “Adam: A method for stochastic optimization,” in _Proc. ICLR_, 2015.
- \[40\] A. Zeyer, E. Beck, R. Schlüter, and H. Ney, “CTC in the Context of Generalized Full-Sum HMM Training,” in _INTERSPEECH_, 2017.
- \[41\] Z. Chen, Y. Zhuang, Y. Qian, K. Yu, Z. Chen, Y. Zhuang, Y. Qian, K. Yu, K. Yu, Y. Zhuang, Z. Chen, and Y. Qian, “Phone synchronous speech recognition with ctc lattices,” _IEEE/ACM Trans. Audio, Speech and Lang. Proc._, 2017.
- \[42\] A. Rosenberg, K. Audhkhasi, A. Sethy, B. Ramabhadran, and M. Picheny, “End-to-end speech recognition and keyword search on low-resource languages,” in _ICASSP_, 2017.
