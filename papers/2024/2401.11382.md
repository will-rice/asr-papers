...
|  |  |
|----|----|
|  Short-form ASR |  $`S_{i},{S_{j}\left| \text{asr} \right|T_{i}},T_{j}`$ |
|  Long-form ASR |  $`S_{i - 1},\gamma,{S_{i}\left| \text{asr} \right|T_{i - 1}\left| \text{sep} \right|T_{i}}`$ |
|  CoT NER |  $`S_{i - 1},\gamma,{S_{i}\left| \text{asr} \right|T_{i - 1}\left| \text{sep} \right|T_{i}\left| \text{ner} \right|{\hat{T}}_{i}}`$ |
