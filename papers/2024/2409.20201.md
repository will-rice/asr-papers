...
1.  1.
    We aggregate more than 10,000 hours of speech, covering more than 1,200 African languages and dialects.
2.  2.
    We introduce AfriHuBERT, a multilingual SSL model for African languages, comparing continued pretraining and training from scratch over one iteration.
3.  3.
    We evaluate AfriHuBERT against other multilingual SSL models on SLID and ASR, analyzing its predictions for both tasks.
...
Table 2: Performance of SSL models on FLEURS. We report the average F1 (%) and WER (%) scores for all languages (avg_(∗)), and only the 21 African languages (avg). Size refers to each model’s parameters (millions), and Dur denotes their pretraining data size (million hours).
...
Going forward, we focus on AfriHuBERT-*n*, now called AfriHuBERT. We analyze its failure cases on both tasks, assess cross-corpus ASR generalization, and evaluate its performance in extremely low-resource and multi-dialect ASR, comparing it to mHuBERT-147 and MMS.
...
- \[8\] S. Communication, L. Barrault *et al.*, “Seamless: Multilingual expressive and streaming speech translation,” 2023. \[Online\]. Available: [https://arxiv.org/abs/2312.05187](https://arxiv.org/abs/2312.05187)
...
- \[21\] C. Emezue, T. N. Community *et al.*, “The naijavoices dataset: Cultivating large-scale, high-quality, culturally-rich speech data for african languages,” 2025. \[Online\]. Available: [https://arxiv.org/abs/2505.20564](https://arxiv.org/abs/2505.20564)
...
- \[32\] A. Caubrière and E. Gauthier, “Africa-centric self-supervised pretraining for multilingual speech representation in a sub-saharan context,” in *5th Workshop on African Natural Language Processing*, 2024.
