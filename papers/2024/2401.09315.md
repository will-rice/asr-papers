...
Although the formulae below are particularized to the MSE loss function of Eq. (4. Also in part, this work has been supported by the project PID2019-104206GB-I00 funded by MCIN/AEI/10.13039/501100011033.")), it is important to note that the pre-emphasis-based methodology under consideration can, in principle, be adapted to any speech enhancement loss function. Hence, this simple and cheap methodology may potentially become a *default add-on* for training deep neural network-based speech enhancement systems.
...
1.  1.
    $`{{{{{200\text{clean signals}} \times 4}\text{noises}} \times 6}\text{SNRs}} = {4,800}`$,
2.  2.
    $`{{{{{50\text{clean signals}} \times 4}\text{noises}} \times 6}\text{SNRs}} = {1,200}`$, and
3.  3.
    $`{{{{{50\text{clean signals}} \times 8}\text{noises}} \times 6}\text{SNRs}} = {2,400}`$
