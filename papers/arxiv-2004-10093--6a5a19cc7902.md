...
- Anastasopoulos et al. (2016) Antonios Anastasopoulos, David Chiang, and Long Duong. 2016. [An unsupervised probability model for speech-to-translation alignment of low-resource languages](https://doi.org/10.18653/v1/d16-1133). In _EMNLP 2016_, pages 1255–1263. The Association for Computational Linguistics.
...
- Bahdanau et al. (2015) Dzmitry Bahdanau, Kyunghyun Cho, and Yoshua Bengio. 2015. Neural machine translation by jointly learning to align and translate. In _ICLR 2015_.
...
- Bansal et al. (2019) Sameer Bansal, Herman Kamper, Karen Livescu, Adam Lopez, and Sharon Goldwater. 2019. [Pre-training on high-resource speech recognition improves low-resource speech-to-text translation](https://doi.org/10.18653/v1/n19-1006). In _NAACL-HLT 2019_, pages 58–68. Association for Computational Linguistics.
- Bender et al. (2004) Oliver Bender, Richard Zens, Evgeny Matusov, and Hermann Ney. 2004. [Alignment templates: the RWTH SMT system](http://www.isca-speech.org/archive/iswlt_04/slt4_079.html). In _IWSLT 2004_, pages 79–84.
- Bengio et al. (2009) Yoshua Bengio, Jérôme Louradour, Ronan Collobert, and Jason Weston. 2009. Curriculum learning. In _ICML 2009_, pages 41–48.
- Berard et al. (2018) Alexandre Berard, Laurent Besacier, Ali Can Kocabiyikoglu, and Olivier Pietquin. 2018. [End-to-end automatic speech translation of audiobooks](https://doi.org/10.1109/ICASSP.2018.8461690). In _ICASSP 2018_, pages 6224–6228. IEEE.
...
- Chan et al. (2016) William Chan, Navdeep Jaitly, Quoc V. Le, and Oriol Vinyals. 2016. [Listen, attend and spell: A neural network for large vocabulary conversational speech recognition](https://doi.org/10.1109/ICASSP.2016.7472621). In _ICASSP 2016_, pages 4960–4964.
- Chiu et al. (2018) Chung-Cheng Chiu, Tara N. Sainath, Yonghui Wu, Rohit Prabhavalkar, Patrick Nguyen, Zhifeng Chen, Anjuli Kannan, Ron J. Weiss, Kanishka Rao, Ekaterina Gonina, Navdeep Jaitly, Bo Li, Jan Chorowski, and Michiel Bacchiani. 2018. [State-of-the-art speech recognition with sequence-to-sequence models](https://doi.org/10.1109/ICASSP.2018.8462105). In _ICASSP 2018_, pages 4774–4778.
- Devlin et al. (2019) Jacob Devlin, Ming-Wei Chang, Kenton Lee, and Kristina Toutanova. 2019. [BERT: pre-training of deep bidirectional transformers for language understanding](https://doi.org/10.18653/v1/n19-1423). In _NAACL-HLT 2019_, pages 4171–4186.
- Duong et al. (2016) Long Duong, Antonios Anastasopoulos, David Chiang, Steven Bird, and Trevor Cohn. 2016. [An attentional model for speech translation without transcription](https://doi.org/10.18653/v1/n16-1109). In _NAACL HLT 2016_, pages 949–959. The Association for Computational Linguistics.
- Gong et al. (2016) Chen Gong, Dacheng Tao, Stephen J. Maybank, Wei Liu, Guoliang Kang, and Jie Yang. 2016. [Multi-modal curriculum learning for semi-supervised image classification](https://doi.org/10.1109/TIP.2016.2563981). _IEEE Trans. Image Processing_, 25(7):3249–3260.
- Graves et al. (2017) Alex Graves, Marc G. Bellemare, Jacob Menick, Rémi Munos, and Koray Kavukcuoglu. 2017. [Automated curriculum learning for neural networks](http://proceedings.mlr.press/v70/graves17a.html). In _ICML 2017_, pages 1311–1320.
- Inaguma et al. (2019) Hirofumi Inaguma, Kevin Duh, Tatsuya Kawahara, and Shinji Watanabe. 2019. [Multilingual end-to-end speech translation](https://doi.org/10.1109/ASRU46091.2019.9003832). In _ASRU 2019_, pages 570–577. IEEE.
- Jia et al. (2019) Ye Jia, Melvin Johnson, Wolfgang Macherey, Ron J. Weiss, Yuan Cao, Chung-Cheng Chiu, Naveen Ari, Stella Laurenzo, and Yonghui Wu. 2019. [Leveraging weakly supervised data to improve end-to-end speech-to-text translation](https://doi.org/10.1109/ICASSP.2019.8683343). In _ICASSP 2019_, pages 7180–7184. IEEE.
- Jiang et al. (2019) Dongwei Jiang, Xiaoning Lei, Wubo Li, Ne Luo, Yuxuan Hu, Wei Zou, and Xiangang Li. 2019. [Improving transformer-based speech recognition using unsupervised pre-training](http://arxiv.org/abs/1910.09932). _CoRR_, abs/1910.09932.
- Kano et al. (2017) Takatomo Kano, Sakriani Sakti, and Satoshi Nakamura. 2017. [Structured-based curriculum learning for end-to-end english-japanese speech translation](http://www.isca-speech.org/archive/Interspeech_2017/abstracts/0944.html). In _Interspeech 2017_, pages 2630–2634.
- Karita et al. (2019) Shigeki Karita, Xiaofei Wang, Shinji Watanabe, Takenori Yoshimura, Wangyou Zhang, Nanxin Chen, Tomoki Hayashi, Takaaki Hori, Hirofumi Inaguma, Ziyan Jiang, Masao Someki, Nelson Enrique Yalta Soplin, and Ryuichi Yamamoto. 2019. [A comparative study on transformer vs RNN in speech applications](https://doi.org/10.1109/ASRU46091.2019.9003750). In _IEEE Automatic Speech Recognition and Understanding Workshop, ASRU 2019, Singapore, December 14-18, 2019_, pages 449–456. IEEE.
- Kocabiyikoglu et al. (2018) Ali Can Kocabiyikoglu, Laurent Besacier, and Olivier Kraif. 2018. [Augmenting librispeech with french translations: A multimodal corpus for direct speech translation evaluation](http://www.lrec-conf.org/proceedings/lrec2018/summaries/621.html). In _LREC 2018_.
- Kudo and Richardson (2018) Taku Kudo and John Richardson. 2018. [Sentencepiece: A simple and language independent subword tokenizer and detokenizer for neural text processing](https://doi.org/10.18653/v1/d18-2012). In _EMNLP 2018: System Demonstrations_, pages 66–71.
- Liu et al. (2019) Yuchen Liu, Hao Xiong, Zhongjun He, Jiajun Zhang, Hua Wu, Haifeng Wang, and Chengqing Zong. 2019. [End-to-end speech translation with knowledge distillation](http://arxiv.org/abs/1904.08075). In _InterSpeech 2019_, volume abs/1904.08075.
- Luong et al. (2015) Thang Luong, Hieu Pham, and Christopher D. Manning. 2015. [Effective approaches to attention-based neural machine translation](https://doi.org/10.18653/v1/d15-1166). In _EMNLP 2015_, pages 1412–1421.
- Mathias and Byrne (2006) Lambert Mathias and William Byrne. 2006. [Statistical phrase-based speech translation](https://doi.org/10.1109/ICASSP.2006.1660082). In _ICASSP 2006_, pages 561–564.
- Matusov et al. (2005) Evgeny Matusov, Stephan Kanthak, and Hermann Ney. 2005. [On the integration of speech recognition and statistical machine translation](http://www.isca-speech.org/archive/interspeech_2005/i05_3177.html). In _INTERSPEECH 2005_, pages 3177–3180.
- McAuliffe et al. (2017) Michael McAuliffe, Michaela Socolof, Sarah Mihuc, Michael Wagner, and Morgan Sonderegger. 2017. [Montreal forced aligner: Trainable text-speech alignment using kaldi](http://www.isca-speech.org/archive/Interspeech_2017/abstracts/1386.html). In _Interspeech 2017_, pages 498–502.
- Meignier and Merlin (2010) Sylvain Meignier and Teva Merlin. 2010. Lium spkdiarization: an open source toolkit for diarization. In _CMU SPUD Workshot_.
- Ney (1999) Hermann Ney. 1999. [Speech translation: coupling of recognition and translation](https://doi.org/10.1109/ICASSP.1999.758176). In _ICASSP ’99_, pages 517–520.
- Niehues et al. (2018) Jan Niehues, Ronaldo Cattoni, Sebastian Stüker, Mauro Cettolo, Marco Turchi, and Marcello Federico. 2018. The iwslt 2018 evaluation campaign. In _Proceedings of IWSLT_.
...
- Park et al. (2019) Daniel S. Park, William Chan, Yu Zhang, Chung-Cheng Chiu, Barret Zoph, Ekin D. Cubuk, and Quoc V. Le. 2019. [Specaugment: A simple data augmentation method for automatic speech recognition](http://arxiv.org/abs/1904.08779). _CoRR_, abs/1904.08779.
- Rousseau et al. (2014) Anthony Rousseau, Paul Deléglise, and Yannick Estève. 2014. [Enhancing the TED-LIUM corpus with selected data for language modeling and more TED talks](http://www.lrec-conf.org/proceedings/lrec2014/summaries/1104.html). In _LREC 2014_, pages 3935–3939. European Language Resources Association (ELRA).
- Sperber et al. (2019) Matthias Sperber, Graham Neubig, Jan Niehues, and Alex Waibel. 2019. [Attention-passing models for robust and data-efficient end-to-end speech translation](https://transacl.org/ojs/index.php/tacl/article/view/1628). _TACL_, 7:313–325.
- Vaswani et al. (2017) Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz Kaiser, and Illia Polosukhin. 2017. [Attention is all you need](http://papers.nips.cc/paper/7181-attention-is-all-you-need). In _NeurIPS 2017_, pages 5998–6008.
- Wang et al. (2019a) Chengyi Wang, Yu Wu, Yujiao Du, Jinyu Li, Shujie Liu, Liang Lu, Shuo Ren, Guoli Ye, Sheng Zhao, and Ming Zhou. 2019a. [Semantic mask for transformer based end-to-end speech recognition](http://arxiv.org/abs/1912.03010). _CoRR_, abs/1912.03010.
- Wang et al. (2019b) Chengyi Wang, Yu Wu, Shujie Liu, Zhenglu Yang, and Ming Zhou. 2019b. [Bridging the gap between pre-training and fine-tuning for end-to-end speech translation](http://arxiv.org/abs/1909.07575). _CoRR_, abs/1909.07575.
- Watanabe et al. (2018) Shinji Watanabe, Takaaki Hori, Shigeki Karita, Tomoki Hayashi, Jiro Nishitoba, Yuya Unno, Nelson Enrique Yalta Soplin, Jahn Heymann, Matthew Wiesner, Nanxin Chen, Adithya Renduchintala, and Tsubasa Ochiai. 2018. [Espnet: End-to-end speech processing toolkit](https://doi.org/10.21437/Interspeech.2018-1456). In _Interspeech 2018_, pages 2207–2211. ISCA.
- Weiss et al. (2017) Ron J. Weiss, Jan Chorowski, Navdeep Jaitly, Yonghui Wu, and Zhifeng Chen. 2017. [Sequence-to-sequence models can directly translate foreign speech](http://www.isca-speech.org/archive/Interspeech_2017/abstracts/0503.html). In _Interspeech 2017_, pages 2625–2629. ISCA.
