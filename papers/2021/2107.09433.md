...
1.  1.  identification of all manually defined IWs in the benchmark;
2.  2.  reduction to a minimum set of IWs, by removing ambiguities. Given that A, B, C, etc. are single words, some cases are:
    - •
...
3.  3.  regeneration of the benchmark, by applying the following steps:
