...
1.  1.
    one-hot representation of the context ($`o`$)
2.  2.
    transforming context ($`c`$) using a contextual embedding matrix $`W`$
3.  3.
    feature engineered constant sized vectors ($`f`$).
...
1.  1.
    the positional time encoding has an 8 dimensional context vector
2.  2.
    one-hot geographical information has a 21 dimensional context vector
