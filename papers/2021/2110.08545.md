...
## References
- Bérard et al. (2018) Alexandre Bérard, Laurent Besacier, Ali Can Kocabiyikoglu, and Olivier Pietquin. 2018. [End-to-end automatic speech translation of audiobooks](https://doi.org/10.1109/ICASSP.2018.8461690). In *2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*. IEEE.
- Dehak et al. (2011a) Najim Dehak, Pedro A.Torres-Carrasquillo, Douglas Reynolds, and Reda Dehak. 2011a. [Language recognition via ivectors and dimensionality reduction](https://www.isca-speech.org/archive/archive_papers/interspeech_2011/i11_0857.pdf). In *INTERSPEECH 2011 – 12^(th) Annual Conference of the International Speech Communication Association*, pages 857–860.
- Dehak et al. (2011b) Najim Dehak, Patrick J Kenny, Réda Dehak, Pierre Dumouchel, and Pierre Ouellet. 2011b. [Front-end factor analysis for speaker verification](https://doi.org/10.1109/TASL.2010.2064307). *IEEE Transactions on Audio, Speech, and Language Processing*, 19(4):788–798.
- Ding et al. (2020) Fenglin Ding, Wu Guo, Lirong Dai, and Jun Du. 2020. [Attention-based gated scaling adaptive acoustic model for CTC-based speech recognition](https://doi.org/10.1109/ICASSP40776.2020.9053967). In *2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*.
- Dong et al. (2018) Linhao Dong, Shuang Xu, and Bo Xu. 2018. [Speech-transformer: A no-recurrence sequence-to-sequence model for speech recognition](https://doi.org/10.1109/ICASSP.2018.8462506). In *2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 5884–5888. IEEE.
- Fan et al. (2019) Zhiyun Fan, Jie Li, Shiyu Zhou, and Bo Xu. 2019. [Speaker-aware speech-transformer](https://doi.org/10.1109/ASRU46091.2019.9003844). In *2019 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*, pages 222–229.
- Frankle and Carbin (2019) Jonathan Frankle and Michael Carbin. 2019. [The lottery ticket hypothesis: Finding sparse, trainable neural networks](https://arxiv.org/abs/1803.03635). In *2019 International Conference on Learning Representations (ICLR)*.
- Furui (1980) S. Furui. 1980. [A training procedure for isolated word recognition systems](https://doi.org/10.1109/TASSP.1980.1163393). *IEEE Transactions on Audio, Speech, and Language Processing*, 28(2):129–136.
- Gales (1998) Mark J. F. Gales. 1998. [Cluster adaptive training for speech recognition](https://www.isca-speech.org/archive/icslp_1998/i98_0375.html). *Int. Conf. Speech Language Processing*, 5:1783–1786.
- Gauvain and Lee (1994) J.-L. Gauvain and Chin-Hui Lee. 1994. [Maximum a posteriori estimation for multivariate gaussian mixture observations of markov chains](https://doi.org/10.1109/89.279278). *IEEE Transactions on Audio, Speech, and Language Processing*, 2(2):291–298.
- Graves (2012) Alex Graves. 2012. [Sequence transduction with recurrent neural networks](https://arxiv.org/abs/1211.3711). In *International Conference of Machine Learning (ICML)*, pages 235–242.
- Gulati et al. (2020) Anmol Gulati, James Qin, Chung-Cheng Chiu, Niki Parmar, Yu Zhang, Jiahui Yu, Wei Han, Shibo Wang, Zhengdong Zhang, Yonghui Wu, and Ruoming Pang. 2020. [Conformer: Convolution-augmented transformer for speech recognition](https://arxiv.org/abs/2005.08100). In *INTERSPEECH 2020 – 21^(st) Annual Conference of the International Speech Communication Association*, pages 5036–5040.
- Han et al. (2015) Song Han, Jeff Pool, John Tran, and William J. Dally. 2015. [Learning both weights and connections for efficient neural networks](https://arxiv.org/abs/1506.02626). In *Advances in Neural Information Processing Systems 28: Annual Conference on Neural Information Processing Systems*.
- Hsu et al. (2020) Wei-Ning Hsu, Ann Lee, Gabriel Synnaeve, and Awni Hannun. 2020. [Self-supervised speech recognition via local prior matching](https://arxiv.org/abs/2002.10336). *arXiv preprint arXiv:2002.10336*.
- Irie et al. (2019) Kazuki Irie, Rohit Prabhavalkar, Anjuli Kannan, Antoine Bruguier, David Rybach, and Patrick Nguyen. 2019. [On the choice of modeling unit for sequence-to-sequence speech recognition](https://arxiv.org/abs/1902.01955). In *INTERSPEECH 2019 – 20^(th) Annual Conference of the International Speech Communication Association*.
- Kahn et al. (2020) Jacob Kahn, Ann Lee, and Awni Hannun. 2020. [Self-training for end-to-end speech recognition](https://doi.org/10.1109/ICASSP40776.2020.9054295). In *2020 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*. IEEE.
- Karafiat et al. (2011) Martin Karafiat, Lukas Burget, Pavel Matejka, Ondrej Glembek, and Jan Cernocky. 2011. [iVector-based discriminative adaptation for automatic speech recognition](https://doi.org/10.1109/ASRU.2011.6163922). In *2011 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*, pages 152–157.
- Keith and Matthias (2005) Johnson Keith and Sjerps Matthias. 2005. [Speaker normalization in speech perception](http://linguistics.berkeley.edu/~kjohnson/papers/revised_chapter.pdf). In *The Handbook of Speech Perception*, pages 363–389. Wiley Online Library.
- Kim et al. (2017) Taesup Kim, Inchul Song, and Yoshua Bengio. 2017. [Dynamic layer normalization for adaptive neural acoustic modeling in speech recognition](https://arxiv.org/abs/1707.06065). In *INTERSPEECH 2017 – 18^(th) Annual Conference of the International Speech Communication Association*.
- Kirkpatrick et al. (2017) James Kirkpatrick, Razvan Pascanu, Neil Rabinowitz, Joel Veness, Guillaume Desjardins, Andrei A. Rusu, Kieran Milan, John Quan, Tiago Ramalho, Agnieszka Grabska-Barwinska, Demis Hassabis, Claudia Clopath, Dharshan Kumaran, and Raia Hadsell. 2017. [Overcoming catastrophic forgetting in neural networks](https://arxiv.org/abs/1612.00796). In *Proceedings of the national academy of sciences*, pages 3521–3526.
- Kuhn et al. (2000) Roland Kuhn, Jean-Claude Junqua, Patrick Nguyen, and Nancy Niedzielski. 2000. [Rapid speaker adaptation in eigenvoice space](https://doi.org/10.1109/89.876308). *IEEE Transactions on Audio, Speech, and Language Processing*, 8(6):695–707.
- Li et al. (2017) Hao Li, Asim Kadav, Igor Durdanovic, Hanan Samet, and Hans Peter Graf. 2017. [Pruning filters for efficient convnets](https://arxiv.org/abs/1608.08710). In *2017 International Conference on Learning Representations (ICLR)*.
- Liang et al. (2021) Jianze Liang, Chengqi Zhao, Mingxuan Wang, Xipeng Qiu, and Lei Li. 2021. [Finding sparse structures for domain specific neural machine translation](https://arxiv.org/abs/2012.10586). In *The Thirty-Fifth AAAI Conference on Artificial Intelligence, AAAI 2021*.
- Liao (2013) Hank Liao. 2013. [Speaker adaptation of context dependent deep neural networks](https://doi.org/10.1109/ICASSP.2013.6639212). In *2013 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 7947–7951.
- Liu et al. (2019) Zhuang Liu, Mingjie Sun, Tinghui Zhou, Gao Huang, and Trevor Darrell. 2019. [Rethinking the value of network pruning](https://arxiv.org/abs/1810.05270). In *2019 International Conference on Learning Representations (ICLR)*.
- Lüscher et al. (2019) Christoph Lüscher, Eugen Beck, Kazuki Irie, Markus Kitza, Wilfried Michel, Albert Zeyer, Ralf Schlüter, and Hermann Ney. 2019. [RWTH asr systems for librispeech: Hybrid vs attention](https://doi.org/10.21437/Interspeech.2019-1780). In *INTERSPEECH 2019 – 20^(th) Annual Conference of the International Speech Communication Association*, pages 231–235.
...
- Meng et al. (2019) Zhong Meng, Jinyu Li, and Yifan Gong. 2019. [Adversarial speaker adaptation](https://arxiv.org/abs/1904.12407). In *2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 5721–5725.
- Miao et al. (2015) Yajie Miao, Mohammad Gowayyed, and Florian Metze. 2015. [EESEN: End-to-end speech recognition using deep rnn models and wfst-based decoding](https://doi.org/10.1109/ASRU.2015.7404790). In *2015 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*, pages 167–174.
- Ochiai et al. (2018) Tsubasa Ochiai, Shinji Watanabe, Shigeru Katagiri, Takaaki Hori, and John Hershey. 2018. [Speaker adaptation for multichannel end-to-end speech recognition](https://doi.org/10.1109/ICASSP.2018.8462161). In *2018 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 6707–6711. IEEE.
- Pan et al. (2018) Jia Pan, Diyuan Liu, Genshun Wan, Jun Du, Qingfeng Liu, and Zhongfu Ye. 2018. [Online speaker adaptation for LVCSR based on attention mechanism](https://doi.org/10.23919/APSIPA.2018.8659609). *2018 Asia-Pacific Signal and Information Processing Association Annual Summit and Conference (APSIPA ASC)*, pages 183–186.
- Panayotov et al. (2015) Vassil Panayotov, Guoguo Chen, Daniel Povey, and Sanjeev Khudanpur. 2015. Librispeech: An ASR corpus based on public domain audio books. In *2015 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*. IEEE.
- Povey et al. (2011) Daniel Povey, Arnab Ghoshal, Gilles Boulianne, Lukas Burget, Ondrej Glembek, Nagendra Goel, Mirko Hannemann, Petr Motlicek, Yanmin Qian, Petr Schwarz, Jan Silovsky, Georg Stemmer, and Karel Vesely. 2011. [The kaldi speech recognition toolkit](https://www.danielpovey.com/files/2011_asru_kaldi.pdf). In *2011 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*.
- Samarakoon and Sim (2016a) Lahiru Samarakoon and Khe Chai Sim. 2016a. [Factorized hidden layer adaptation for deep neural network based acoustic modeling](https://doi.org/10.1109/TASLP.2016.2601146). *IEEE/ACM Transactions on Audio, Speech, and Language Processing*, 24(12):2241–2250.
- Samarakoon and Sim (2016b) Lahiru Samarakoon and Khe Chai Sim. 2016b. [Subspace LHUC for fast adaptation of deep neural network acoustic models](https://doi.org/10.21437/Interspeech.2016-1249). In *INTERSPEECH 2016 – 17^(th) Annual Conference of the International Speech Communication Association*, pages 1593–1597.
- Saon et al. (2013) George Saon, Hagen Soltau, David Nahamoo, and Michael Picheny. 2013. [Speaker adaptation of neural network acoustic models using i-vectors](https://doi.org/10.1109/ASRU.2013.6707705). In *2013 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*.
- Seide et al. (2011) Frank Seide, Gang Li, Xie Chen, and Dong Yu. 2011. [Feature engineering in context-dependent deep neural networks for conversational speech transcription](https://doi.org/10.1109/ASRU.2011.6163899). In *2011 IEEE Automatic Speech Recognition and Understanding Workshop (ASRU)*.
- Senior and Lopez-Moreno (2014) Andrew Senior and Ignacio Lopez-Moreno. 2014. [Improving DNN speaker independence with i-vector inputs](https://doi.org/10.1109/ICASSP.2014.6853591). In *2014 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*.
- Siniscalchi et al. (2013) Sabato Marco Siniscalchi, Jinyu Li, and Chin-Hui Lee. 2013. [Hermitian polynomial for speaker adaptation of connectionist speech recognition systems](https://doi.org/10.1109/TASL.2013.2270370). *IEEE Transactions on Audio, Speech, and Language Processing*, 21(10):2152–2161.
- Swietojanski et al. (2016) Pawel Swietojanski, Jinyu Li, and Steve Renals. 2016. [Learning hidden unit contributions for unsupervised acoustic model adaptation](https://doi.org/10.1109/SLT.2014.7078569). *IEEE/ACM Transactions on Audio, Speech and Language Processing*, 24(8):1450–1463.
- Tomashenko and Estève (2018) Natalia Tomashenko and Yannick Estève. 2018. [Evaluation of feature-space speaker adaptation for end-to-end acoustic models](https://www.aclweb.org/anthology/L18-1500). In *Proceedings of the Eleventh International Conference on Language Resources and Evaluation (LREC 2018)*.
- Vaswani et al. (2017) Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz Kaiser, and Illia Polosukhin. 2017. [Attention is all you need](https://arxiv.org/abs/1706.03762). In *Advances in Neural Information Processing Systems*, pages 5998–6008.
- Vesely et al. (2016) Karel Vesely, Shinji Watanabe, Katerina Zmolikova, Martin Karafiat, Lukas Burget, and Jan Honza Cernocky. 2016. [Sequence summarizing neural network for speaker adaptation](https://doi.org/10.1109/ICASSP.2016.7472692). In *2016 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 5315–5319. IEEE.
- Watanabe et al. (2018) Shinji Watanabe, Takaaki Hori, Shigeki Karita, Tomoki Hayashi, Jiro Nishitoba, Yuya Unno, Nelson Enrique Yalta Soplin, Jahn Heymann, Matthew Wiesner, Nanxin Chen, Adithya Renduchintala, and Tsubasa Ochiai. 2018. [Espnet: End-to-end speech processing toolkit](https://arxiv.org/abs/1804.00015). In *INTERSPEECH 2018 – 19^(th) Annual Conference of the International Speech Communication Association*, pages 2207–2211.
- Xie et al. (2019) Xurong Xie, Xunying Liu, Tan Lee, Shoukang Hu, and Lan Wang. 2019. [BLHUC: Bayesian learning of hidden unit contributions for deep neural network speaker adaptation](https://doi.org/10.1109/ICASSP.2019.8682667). In *2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 5711–5715.
- Yao et al. (2012) Kaisheng Yao, Dong Yu, Frank Seide, Hang Su, Li Deng, and Yifan Gong. 2012. [Adaptation of context-dependent deep neural networks for automatic speech recognition](https://doi.org/10.1109/SLT.2012.6424251). In *2012 IEEE Spoken Language Technology Workshop (SLT)*. IEEE.
- You et al. (2019) Zhao You, Dan Su, Jie Chen, Chao Weng, and Dong Yu. 2019. [DFSMN-SAN with persistent memory model for automatic speech recognition](https://arxiv.org/pdf/1910.13282.pdf). *arXiv preprint arXiv:1910.13282*.
- Yu et al. (2013) Dong Yu, Kaisheng Yao, Hang Su, Gang Li, and Frank Seide. 2013. [KL-divergence regularized deep neural network adaptation for improved large vocabulary speech recognition](https://doi.org/10.1109/ICASSP.2013.6639201). In *2013 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 7893–7897.
- Yu and Gales (2006) Kai Yu and Mark J. F. Gales. 2006. [Discriminative cluster adaptive training](https://doi.org/10.1109/TSA.2005.858555). *IEEE Transactions on Audio, Speech, and Language Processing*, 14(5):1694–1703.
- Zhang et al. (2017) Yu Zhang, William Chan, and Navdeep Jaitly. 2017. [Very deep convolutional networks for end-to-end speech recognition](https://doi.org/10.1109/ICASSP.2017.7953077). In *2017 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 4845–4849. IEEE.
- Zhao et al. (2020) Yingzhu Zhao, Chongjia Ni, Cheung-Chi Leung, Shafiq Joty, Eng Siong Chng, and Bin Ma. 2020. [Speech transformer with speaker aware persistent memory](https://www.isca-speech.org/archive/Interspeech_2020/pdfs/1281.pdf). In *INTERSPEECH 2020 – 21^(st) Annual Conference of the International Speech Communication Association*, pages 1261–1265.
- Zhu and Gupta (2018) Michael Zhu and Suyog Gupta. 2018. [To prune, or not to prune: exploring the efficacy of pruning for model compression](https://arxiv.org/abs/1710.01878). In *2018 International Conference on Learning Representations (ICLR)*.
