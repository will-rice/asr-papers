---
arxiv_id: '2108.07980'
title: A Multi-level Acoustic Feature Extraction Framework for Transformer Based End-to-End
  Speech Recognition
authors:
- Jin Li
- Rongfeng Su
...
- 1.
  A novel multi-level acoustic feature extraction framework is proposed in this paper. Speaker-related information can be derived from the deep stream to improve the diversity of the feature representations of speech signal.
- 2.
  An additional feature correlation based fusion strategy is proposed to integrate two different types of feature expressions across the frequency and time domains.
- 3.
  The Transformer based ASR system using the proposed multi-level acoustic feature extraction framework gave state-of-the-art error rates of 21.7% and 2.5% on the HKUST Mandarin telephone speech \[17\] and Librispeech \[18\] recognition tasks respectively.
...
- \[2\] X. Chen, Y. Wu, Z. Wang, S. Liu, and J. Li, “Developing real-time streaming transformer transducer for speech recognition on large-scale dataset,” in *Proceedings of IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, 2021, pp. 5904–5908.
...
- \[8\] C. Lüscher, E. Beck, K. Irie, M. Kitza, W. Michel, A. Zeyer, R. Schlüter, and H. Ney, “Rwth asr systems for librispeech: Hybrid vs attention–w/o data augmentation,” *arXiv preprint arXiv:1905.03072*, 2019.
