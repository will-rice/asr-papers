---
arxiv_id: '2109.06253'
title: 'Multi-Sentence Resampling: A Simple Approach to Alleviate Dataset Length Bias
...
- Ding et al. (2019) Shuoyang Ding, Adithya Renduchintala, and Kevin Duh. 2019. [A call for prudent choice of subword merge operations in neural machine translation](https://www.aclweb.org/anthology/W19-6620). In *Proceedings of Machine Translation Summit XVII Volume 1: Research Track*, pages 204–213, Dublin, Ireland. European Association for Machine Translation.
...
- Koehn (2004) Philipp Koehn. 2004. [Statistical significance tests for machine translation evaluation](https://www.aclweb.org/anthology/W04-3250). In *Proceedings of the 2004 Conference on Empirical Methods in Natural Language Processing*.
...
- Kumar and Sarawagi (2019) Aviral Kumar and Sunita Sarawagi. 2019. [Calibration of encoder decoder models for neural machine translation](http://arxiv.org/abs/1903.00802). *CoRR*, abs/1903.00802.
- Marzal and Vidal (1993) A. Marzal and E. Vidal. 1993. [Computation of normalized edit distance and applications](https://doi.org/10.1109/34.232078). *IEEE Transactions on Pattern Analysis and Machine Intelligence*, 15(9):926–932.
...
- Sountsov and Sarawagi (2016) Pavel Sountsov and Sunita Sarawagi. 2016. [Length bias in encoder decoder models and a case for global conditioning](https://doi.org/10.18653/v1/D16-1158). In *Proceedings of the 2016 Conference on Empirical Methods in Natural Language Processing*, pages 1516–1525, Austin, Texas. Association for Computational Linguistics.
