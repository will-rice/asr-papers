...
- Arivazhagan et al. (2020) Naveen Arivazhagan, Colin Cherry, I Te, Wolfgang Macherey, Pallavi Baljekar, and George F. Foster. 2020. [Re-translation strategies for long form, simultaneous, spoken language translation](https://doi.org/10.1109/ICASSP40776.2020.9054585). In _Proc. ICASSP_.
- Chen et al. (2020) Tanfang Chen, Weiwei Wang, Wenyang Wei, Xing Shi, Xiangang Li, Jieping Ye, and Kevin Knight. 2020. [DiDi’s machine translation system for WMT2020](https://www.aclweb.org/anthology/2020.wmt-1.7). In _Proc. WMT_.
- Cho et al. (2013) Eunah Cho, C. Fügen, T. Herrmann, Kevin Kilgour, M. Mediani, Christian Mohr, J. Niehues, Kay Rottmann, Christian Saam, S. Stüker, and A. Waibel. 2013. A real-world system for simultaneous translation of german lectures. In _INTERSPEECH_.
...
- Gu et al. (2017) Jiatao Gu, Graham Neubig, Kyunghyun Cho, and Victor O.K. Li. 2017. [Learning to translate in real-time with neural machine translation](https://www.aclweb.org/anthology/E17-1099). In _Proc. EACL_.
- Huang et al. (2020) Liang Huang, Colin Cherry, Mingbo Ma, Naveen Arivazhagan, and Zhongjun He. 2020. [Simultaneous translation](https://doi.org/10.18653/v1/2020.emnlp-tutorials.6). In _Proc. EMNLP: Tutorial Abstracts_.
- Ma et al. (2019) Mingbo Ma, Liang Huang, Hao Xiong, Renjie Zheng, Kaibo Liu, Baigong Zheng, Chuanqiang Zhang, Zhongjun He, Hairong Liu, Xing Li, Hua Wu, and Haifeng Wang. 2019. [STACL: Simultaneous translation with implicit anticipation and controllable latency using prefix-to-prefix framework](https://doi.org/10.18653/v1/P19-1289). In _Proc. ACL_.
- Niehues et al. (2016) J. Niehues, T. Nguyen, Eunah Cho, Thanh-Le Ha, Kevin Kilgour, M. Müller, Matthias Sperber, S. Stüker, and A. Waibel. 2016. Dynamic transcription for low-latency speech translation. In _INTERSPEECH_.
- Niehues et al. (2018) J. Niehues, Ngoc-Quan Pham, Thanh-Le Ha, Matthias Sperber, and A. Waibel. 2018. Low-latency neural speech translation. In _INTERSPEECH_.
- Papineni et al. (2002) Kishore Papineni, Salim Roukos, Todd Ward, and Wei-Jing Zhu. 2002. [Bleu: a method for automatic evaluation of machine translation](https://doi.org/10.3115/1073083.1073135). In _Proc. ACL_.
- Park et al. (2021) Tae Jin Park, Naoyuki Kanda, Dimitrios Dimitriadis, Kyu J. Han, Shinji Watanabe, and Shrikanth Narayanan. 2021. [A review of speaker diarization: Recent advances with deep learning](https://www.microsoft.com/en-us/research/publication/a-review-of-speaker-diarization-recent-advances-with-deep-learning/). _arXiv:2101.09624_.
- Raffel et al. (2017) Colin Raffel, Minh-Thang Luong, Peter J. Liu, Ron J. Weiss, and Douglas Eck. 2017. [Online and linear-time attention by enforcing monotonic alignments](http://proceedings.mlr.press/v70/raffel17a.html). In _Proc. ICML_.
- Sivasankaran et al. (2018) Sunit Sivasankaran, Brij Mohan Lal Srivastava, Sunayana Sitaram, Kalika Bali, and Monojit Choudhury. 2018. [Phone merging for code-switched speech recognition](https://www.microsoft.com/en-us/research/publication/phone-merging-code-switched-speech-recognition/). In _Workshop on Computational Approaches to Linguistic Code Switching_.
- Solorio and Liu (2008) Thamar Solorio and Yang Liu. 2008. [Learning to predict code-switching points](https://www.aclweb.org/anthology/D08-1102). In _Proc. EMNLP_.
- Wang et al. (2016) Xiaolin Wang, Andrew Finch, Masao Utiyama, and Eiichiro Sumita. 2016. [A prototype automatic simultaneous interpretation system](https://www.aclweb.org/anthology/C16-2007). In _Proc. COLING: System Demonstrations_.
- Wu et al. (2021) Hua Wu, Colin Cherry, Liang Huang, Zhongjun He, Qun Liu, Maha Elbayad, Mark Liberman, Haifeng Wang, Mingbo Ma, and Ruiqing Zhang, editors. 2021. [_Proc. Second Workshop on Automatic Simultaneous Translation_](https://www.aclweb.org/anthology/2021.autosimtrans-1.0).
- Wu et al. (2020) Hua Wu, Collin Cherry, Liang Huang, Zhongjun He, Mark Liberman, James Cross, and Yang Liu, editors. 2020. [_Proc. First Workshop on Automatic Simultaneous Translation_](https://www.aclweb.org/anthology/2020.autosimtrans-1.0).
- Yao et al. (2021) Zhuoyuan Yao, Di Wu, Xiong Wang, Binbin Zhang, Fan Yu, Chao Yang, Zhendong Peng, Xiaoyu Chen, Lei Xie, and Xin Lei. 2021. Wenet: Production oriented streaming and non-streaming end-to-end speech recognition toolkit. In _INTERSPEECH_.
...
- Zheng et al. (2019) Baigong Zheng, Renjie Zheng, M. Ma, and Liang Huang. 2019. Simultaneous translation with flexible policy via restricted imitation learning. In _ACL_.
