...
arxiv_id: "2511.14255"
title:
  "AfriSpeech-MultiBench: A Verticalized Multidomain Multicountry Benchmark Suite
...
1.  1.  clean*text —  lower‑cases, trims whitespace, removes punctuation, deletes 32 variants of *\[inaudible\]_, and removes frequent filler words (\_uh_, _hmm_,_mmhmm_,…).
2.  2.  text*to_numbers —  maps number words (*“twenty”_ $`\rightarrow`$ 20) and ordinal words (_“first”\_ $`\rightarrow`$ 1st) to their digit form.
3.  3.  EnglishTextNormalizer —  applies the Whisper normaliser for final case‑folding and whitespace cleanup.
