...
1.  1.
    The W4A16 scheme (when implemented with GAR as in [Tab. 3](https://arxiv.org/html/2505.14638v1#S4.T3 "In 4.2 Accuracy Results ‣ 4 Experiments ‣ Dual Precision Quantization for Efficient and Accurate Deep Neural Networks Inference")), which only quantizes weights and performs computation in BF16, serves as a natural upper bound for our W4A8 approach . That is, we primarily compare our accuracy degradation against W4A16. Optimizing W4A16 (weight-only) is beyond the scope of this paper.
2.  2.
    Our quantization method is orthogonal to many existing quantization strategies, such as AWQ, QuaRot, and others. Incorporating these techniques may further enhance our results. We leave this for future work.
