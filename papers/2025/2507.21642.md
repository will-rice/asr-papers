---
arxiv_id: '2507.21642'
title: 'Whilter: A Whisper-based Data Filter for "In-the-Wild" Speech Corpora Using
...
## References
- \[1\] J. S. Chung, A. Nagrani, and A. Zisserman, \`\`Voxceleb2: Deep speaker recognition,'' in *Interspeech 2018*, 2018, pp. 1086–1090.
- \[2\] X. Li, S. Takamichi, T. Saeki, W. Chen, S. Shiota, and S. Watanabe, \`\`YODAS: Youtube-Oriented Dataset for Audio and Speech,'' in *ASRU 2023*, 2023, pp. 1–8.
...
- \[4\] E. Kharitonov, D. Vincent, Z. Borsos, R. Marinier, S. Girgin, O. Pietquin, M. Sharifi, M. Tagliasacchi, and N. Zeghidour, \`\`Speak, read and prompt: High-fidelity text-to-speech with minimal supervision,'' *Transactions of the Association for Computational Linguistics*, vol. 11, pp. 1703–1718, 2023.
- \[5\] M. Zanon Boito, V. Iyer, N. Lagos, L. Besacier, and I. Calapodescu, \`\`mhubert-147: A compact multilingual hubert model,'' in *Interspeech 2024*, 2024, pp. 3939–3943.
- \[6\] J. Li, D. Sityaev, and J. Hao, \`\`Sentence level intelligibility evaluation for mandarin text-to-speech systems using semantically unpredictable sentences,'' in *Interspeech 2007*, 2007, pp. 1350–1353.
- \[7\] A.-L. Georgescu, C. Manolache, D. Oneaţă, H. Cucu, and C. Burileanu, \`\`Data-filtering methods for self-training of automatic speech recognition systems,'' in *2021 SLT Workshop*, 2021, pp. 1–7.
- \[8\] D. Doukhan, J. Carrive, F. Vallet, A. Larcher, and S. Meignier, \`\`An open-source speaker gender detection framework for monitoring gender equality,'' in *ICASSP 2018*.  IEEE, 2018.
...
- \[10\] H. Bredin, \`\`pyannote.audio 2.1 speaker diarization pipeline: principle, benchmark, and recipe,'' in *Interspeech 2023*, 2023.
- \[11\] R. Reimao and V. Tzerpos, \`\`FoR: A dataset for synthetic speech detection,'' in *2019 International Conference on Speech Technology and Human-Computer Dialogue (SpeD)*, 2019, pp. 1–10.
- \[12\] J.-w. Jung, H.-S. Heo, H. Tak, H.-j. Shim, J. S. Chung, B.-J. Lee, H.-J. Yu, and N. Evans, \`\`AASIST: Audio Anti-Spoofing Using Integrated Spectro-Temporal Graph Attention Networks,'' in *ICASSP 2022*, 2022, pp. 6367–6371.
- \[13\] A. Radford, J. W. Kim, T. Xu, G. Brockman, C. McLeavey, and I. Sutskever, \`\`Robust speech recognition via large-scale weak supervision,'' in *ICML 2023*.  JMLR.org, 2023.
- \[14\] G. Close, W. Ravenscroft, T. Hain, and S. Goetze, \`\`Perceive and predict: Self-supervised speech representation based loss functions for speech enhancement,'' in *ICASSP 2023*, 2023, pp. 1–5.
- \[15\] W. Ravenscroft, G. Close, S. Goetze, T. Hain, M. Soleymanpour, A. Chowdhury, and M. C. Fuhs, \`\`Transcription-free fine-tuning of speech separation models for noisy and reverberant multi-speaker automatic speech recognition,'' in *Interspeech 2024*, 2024, pp. 4998–5002.
- \[16\] R. Mogridge, G. Close, R. Sutherland, T. Hain, J. Barker, S. Goetze, and A. Ragni, \`\`Non-intrusive speech intelligibility prediction for hearing-impaired users using intermediate asr features and human memory models,'' in *ICASSP 2024*, 2024, pp. 306–310.
- \[17\] O. Chetia Phukan, G. Kashyap, A. B. Buduru, and R. Sharma, \`\`Heterogeneity over homogeneity: Investigating multilingual speech pre-trained models for detecting audio deepfake,'' in *NAACL 2024*, Jun. 2024, pp. 2496–2506.
...
- \[19\] G. Mittag, B. Naderi, A. Chehadi, and S. Möller, \`\`Nisqa: A deep cnn-self-attention model for multidimensional speech quality prediction with crowdsourced datasets,'' in *Interspeech 2021*.  ISCA, Aug. 2021.
- \[20\] G. Close, T. Hain, and S. Goetze, \`\`Hallucination in perceptual metric-driven speech enhancement networks,'' in *EUSIPCO 2024*, 2024, pp. 21–25.
...
- \[22\] S. Chen, Y. Wu, C. Wang, S. Liu, D. Tompkins, Z. Chen, W. Che, X. Yu, and F. Wei, \`\`BEATs: Audio pre-training with acoustic tokenizers,'' in *ICML 2023*, A. Krause, E. Brunskill, K. Cho, B. Engelhardt, S. Sabato, and J. Scarlett, Eds., vol. 202, Jul 2023, pp. 5178–5193.
- \[23\] Y. Wu, K. Chen, T. Zhang, Y. Hui, T. Berg-Kirkpatrick, and S. Dubnov, \`\`Large-scale contrastive language-audio pretraining with feature fusion and keyword-to-caption augmentation,'' in *ICASSP 2023*, 2023, pp. 1–5.
- \[24\] N. Zeghidour and D. Grangier, \`\`Wavesplit: End-to-end speech separation by speaker clustering,'' *IEEE/ACM Trans. Audio, Speech and Lang. Proc.*, vol. 29, p. 2840–2849, Jul. 2021.
...
- \[26\] F. Yu, S. Zhang, Y. Fu, L. Xie, S. Zheng, Z. Du, W. Huang, P. Guo, Z. Yan, B. Ma, X. Xu, and H. Bu, \`\`M2Met: The ICASSP 2022 Multi-Channel Multi-Party Meeting Transcription Challenge,'' in *ICASSP 2022*, 2022, pp. 6167–6171.
- \[27\] V. Pratap, Q. Xu, A. Sriram, G. Synnaeve, and R. Collobert, \`\`MLS: A Large-Scale Multilingual Dataset for Speech Research,'' in *Interspeech 2020*, 2020, pp. 2757–2761.
- \[28\] D. Snyder, G. Chen, and D. Povey, \`\`MUSAN: A Music, Speech, and Noise Corpus,'' 2015, arXiv:1510.08484v1.
- \[29\] A. Yaroshchuk, C. Papastergiopoulos, L. Cuccovillo, P. Aichroth, K. Votis, and D. Tzovaras, \`\`An open dataset of synthetic speech,'' in *IEEE WIFS 2023*, 2023, pp. 1–6.
- \[30\] E. J. Humphrey, S. Durand, and B. McFee, \`\`OpenMIC-2018: An Open Dataset for Multiple Instrument Recognition,'' in *ISMIR 2018*, 2018.
- \[31\] E. Fonseca, M. Plakal, D. P. W. Ellis, F. Font, X. Favory, and X. Serra, \`\`Learning sound event classifiers from web audio with noisy labels,'' in *ICASSP 2019*, 2019, pp. 21–25.
- \[32\] J. Thiemann, N. Ito, and E. Vincent, \`\`The Diverse Environments Multi-channel Acoustic Noise Database (DEMAND): A database of multichannel environmental noise recordings,'' in *21st International Congress on Acoustics*, Jun. 2013.
- \[33\] D. P. Kingma and J. Ba, \`\`Adam: A method for stochastic optimization,'' in *ICLR 2015*, May 2015.
...
- \[35\] C. K. A. Reddy, V. Gopal, and R. Cutler, \`\`Dnsmos: A non-intrusive perceptual objective speech quality metric to evaluate noise suppressors,'' in *ICASSP 2021*, 2021, pp. 6493–6497.
- \[36\] E. Cakir, G. Parascandolo, T. Heittola, H. Huttunen, T. Virtanen, E. Cakir, G. Parascandolo, T. Heittola, H. Huttunen, and T. Virtanen, \`\`Convolutional recurrent neural networks for polyphonic sound event detection,'' *IEEE/ACM Trans. Audio, Speech and Lang. Proc.*, vol. 25, no. 6, p. 1291–1303, Jun. 2017.
- \[37\] N. M. Müller, P. Kawa, W. H. Choong, E. Casanova, E. Gölge, T. Müller, P. Syga, P. Sperl, and K. Böttinger, \`\`Mlaad: The multi-language audio anti-spoofing dataset,'' in *IJCNN 2024*, 2024, pp. 1–7.
