...
- Booij (2019) Geert Booij. 2019. *The Morphology of Dutch*. Oxford University Press.
...
- Cucchiarini et al. (2006) Catia Cucchiarini, H Van Hamme, O van Herwijnen, and Felix Smits. 2006. JASMIN-CGN: Extension of the spoken Dutch corpus with speech of elderly people, children and non-natives in the human-machine interaction modality. *The International Conference on Language Resources and Evaluation*.
- Feng et al. (2024) Siyuan Feng, Bence Mark Halpern, Olya Kudina, and Odette Scharenborg. 2024. Towards inclusive automatic speech recognition. *Computer Speech & Language*, 84:101567.
- Oostdijk (2000) Nelleke Oostdijk. 2000. [The Spoken Dutch Corpus. overview and first evaluation](http://www.lrec-conf.org/proceedings/lrec2000/pdf/110.pdf). In *Proceedings of the Second International Conference on Language Resources and Evaluation (LREC’00)*, Athens, Greece. European Language Resources Association (ELRA).
...
- Shi et al. (2021) Xian Shi, Fan Yu, Yizhou Lu, Yuhao Liang, Qiangze Feng, Daliang Wang, Yanmin Qian, and Lei Xie. 2021. The accented English speech recognition challenge 2020: open datasets, tracks, baselines, results and methods. In *ICASSP 2021-2021 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*, pages 6918–6922. IEEE.
- Shibano et al. (2021) Toshiko Shibano, Xinyi Zhang, Mia Taige Li, Haejin Cho, Peter Sullivan, and Muhammad Abdul-Mageed. 2021. [Speech technology for everyone: Automatic speech recognition for non-native English](https://aclanthology.org/2021.icnlsp-1.2). In *Proceedings of the 4th International Conference on Natural Language and Speech Processing (ICNLSP 2021)*, pages 11–20, Trento, Italy. Association for Computational Linguistics.
- Sullivan et al. (2022) Peter Sullivan, Toshiko Shibano, and Muhammad Abdul-Mageed. 2022. Improving automatic speech recognition for non-native English with transfer learning and language model decoding. In *Analysis and Application of Natural Language and Speech Processing*, pages 21–44. Springer.
...
- Viglino et al. (2019) Thibault Viglino, Petr Motlicek, and Milos Cernak. 2019. End-to-end accented speech recognition. In *Interspeech*, pages 2140–2144.
- Wilpon and Jacobsen (1996) Jay G Wilpon and Claus N Jacobsen. 1996. A study of speech recognition for children and the elderly. In *Proceedings of the 1996 IEEE International Conference on Acoustics, Speech, and Signal Processing*, volume 1, pages 349–352. IEEE.
