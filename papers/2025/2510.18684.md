...
Table 7: WER(%) ($`\downarrow`$) Performance of Bilingual ConMamba increasing the training material. 710 = LS (460h)_(EN) + CV_(IT) ; 1210= LS(960h)_(EN) + CV_(IT) and 3334 = LS(960)_(EN) + (CV + VP)_(EN&IT) + MLS_(IT)
