...
We presented our design of a compact large vocabulary speech recognition system that can run efficiently on mobile devices, accurately and with low latency. This is achieved by using a CTC-based LSTM acoustic model which predicts context-independent phones and is compressed to _a tenth of its original size_ using a combination of SVD-based compression \[4, 5\] and quantization.
