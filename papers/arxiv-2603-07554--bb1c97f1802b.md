...
arxiv_id: "2603.07554"
title:
  "Nwāchā Munā: A Devanagari Speech Corpus and Proximal Transfer Benchmark for
  Nepal Bhasha ASR"
authors:
...
1.  1.  We release Nwāchā Munā, a carefully curated 5.39-hour Devanagari speech corpus for Nepal Bhasha.
2.  2.  We provide the first controlled comparison between proximal transfer (Nepali $`\rightarrow`$ Newari) and multilingual pretraining (Whisper) in this ultra-low-resource setting.
3.  3.  We show that script-preserving proximal transfer can match large multilingual models while requiring substantially fewer parameters and computational resources.
