...
1.  1.  add gate to the network to control the scale of word level and sequence level information;
2.  2.  try other ways to extract future vector;
3.  3.  implement different methods to predict future vector;
4.  4.  use reinforcement learning to train the network directly with the sequence level evaluation metric;
5.  5.  use other sequence level tasks to test enhanced LSTM language model.
