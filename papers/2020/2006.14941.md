...
1.  1.
    It prematurely predicts $`\langle`$eos$`\rangle`$ as the attentions reach the end of insufficient encoder blocks.
2.  2.
    It predicts a repeated token because it attends to a position that has already been attended.
