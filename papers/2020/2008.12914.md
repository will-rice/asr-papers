---
arxiv_id: '2008.12914'
title: Data augmentation using prosody and false starts to recognize non-native children's
  speech
authors:
- Hemant Kathania
- Mittul Singh
...
1.  1.
    when only speaking rate (SR) modified data with $`\alpha = 1.1`$ is augmented to the original,
2.  2.
    when only pitch scale (P) modified data with $`s = 0.9`$ is augmented to the original,
3.  3.
    both SR and P modified data are augmented (SR-P) to the original, and
4.  4.
    the original data further augmented with speaking-rate modification with $`\alpha = 1.2`$ and pitch scale modification with $`s = 0.85`$ and added to SR-P (SR2-P2).
...
- \[5\] R. Gretter, M. Matassoni, S. Bannò, and D. Falavigna, “Tlt-school: a corpus of non native children speech,” *CoRR*, vol. abs/2001.08051, 2020. \[Online\]. Available: [https://arxiv.org/abs/2001.08051](https://arxiv.org/abs/2001.08051)
...
- \[11\] W. Ahmad, S. Shahnawazuddin, H. Kathania, G. Pradhan, and A. Samaddar, “Improving children’s speech recognition through explicit pitch scaling based on iterative spectrogram inversion,” in *Interspeech 2017*, 2017, pp. 2391–2395. \[Online\]. Available: [http://dx.doi.org/10.21437/Interspeech.2017-302](http://dx.doi.org/10.21437/Interspeech.2017-302)
