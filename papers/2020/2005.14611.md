...
1.  1.
    We substitute the ASR system’s standard feed-forward NN (fNN) with different network architectures, which are capable of capturing model uncertainty, namely Bayesian NNs (BNN) \[19\], Monte Carlo (MC) dropout \[20\] and deep ensembles \[21\].
2.  2.
    We calculate different measures to assess the uncertainty when predicting an utterance. Specifically, we measure the entropy, variance, averaged Kullback-Leibler divergence, and the mutual information of the NN outputs.
3.  3.
    We train a one-class classifier by fitting a normal distribution on the values w.r.t. these measure for an exemplary set of benign examples. Adversarial examples can then be detected as outliers of the learned distribution. Compared to previous work, this has the advantage that we do not need any adversarial examples to train the classifier and are not tailored to specific kinds of attacks.
...
## References
- \[1\] N. Carlini and D. Wagner, “Audio adversarial examples: Targeted attacks on speech-to-text,” in *IEEE Security and Privacy Workshops (SPW)*.   IEEE, 2018, pp. 1–7.
...
- \[4\] L. Schönherr, T. Eisenhofer, S. Zeiler, T. Holz, and D. Kolossa, “Imperio: Robust over-the-air adversarial examples for automatic speech recognition systems,” *arXiv preprint arXiv:1908.01551*, 2019.
- \[5\] A. Shamir, I. Safran, E. Ronen, and O. Dunkelman, “A simple explanation for the existence of adversarial examples with small Hamming distance,” *arXiv preprint arXiv:1901.10861*, 2019.
...
- \[9\] R. Feinman, R. R. Curtin, S. Shintre, and A. B. Gardner, “Detecting adversarial samples from artifacts,” *arXiv preprint arXiv:1703.00410*, 2017.
- \[10\] V. Akinwande, C. Cintas, S. Speakman, and S. Sridharan, “Identifying audio adversarial examples via anomalous pattern detection,” *arXiv preprint arXiv:2002.05463*, 2020.
- \[11\] S. Samizade, Z.-H. Tan, C. Shen, and X. Guan, “Adversarial example detection by classification for deep speech recognition,” in *IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)*.   IEEE, 2020, pp. 3102–3106.
- \[12\] N. Carlini and D. Wagner, “Adversarial examples are not easily detected: Bypassing ten detection methods,” in *ACM Workshop on Artificial Intelligence and Security*, 2017.
- \[13\] Q. Zeng, J. Su, C. Fu, G. Kayas, L. Luo, X. Du, C. C. Tan, and J. Wu, “A multiversion programming inspired approach to detecting audio adversarial examples,” in *IEEE/IFIP International Conference on Dependable Systems and Networks (DSN)*.   IEEE, 2019, pp. 39–51.
...
- \[18\] C. Huemmer, R. Maas, A. Schwarz, R. F. Astudillo, and W. Kellermann, “Uncertainty decoding for DNN-HMM hybrid systems based on numerical sampling,” in *Sixteenth Annual Conference of the International Speech Communication Association*, 2015.
...
- \[24\] A. Malinin and M. Gales, “Predictive uncertainty estimation via prior networks,” in *Advances in Neural Information Processing Systems 31*, S. Bengio, H. Wallach, H. Larochelle, K. Grauman, N. Cesa-Bianchi, and R. Garnett, Eds.   Curran Associates, Inc., 2018, pp. 7047–7058.
...
- \[28\] R. S. Zimmermann, “Comment on ”Adv-BNN: Improved adversarial defense through robust Bayesian neural network”,” *arXiv preprint arXiv:1907.00895*, 2019.
