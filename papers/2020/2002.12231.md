...
We also compare our end-to-end model with another popular data augmentation strategy, spectral augmentation (SpecAugment). SpecAugment adds perturbations at the feature level, whereas SkinAugment operates at the raw wave level. We use the *LibriSpeech double* setting \[3\].
