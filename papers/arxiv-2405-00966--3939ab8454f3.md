...
1.  1.  Conduct a comprehensive analysis of bias within the Whisper model family, with a specific focus speaker-related (gender, age, accent) and model-related (model size, resourcefulness, similar languages) biases;
2.  2.  Explore how light compression techniques, such as quantization, may either mitigate or exacerbate any identified biases within the Whisper models;
3.  3.  Propose a better compression approach that effectively reduces any disparities found in the models.
