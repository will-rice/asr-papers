...
5. Dzmitry Bahdanau, Dmitriy Serdyuk, Philemon Brakel, Nan~Rosemary Ke, Jan
...
7. Kyunghyun Cho, Bart van Merrienboer, Caglar Gulcehre, Dzmitry Bahdanau, Fethi
   ...
   Processing}, 2014.
8. Jan Chorowski, Dzmitry Bahdanau, Dmitriy Serdyuk, Kyunghyun Cho, and Yoshua
   Bengio.
...
11. Alex Graves and Navdeep Jaitly.
...
12. Alex Graves, Santiago Fernandez, Faustino Gomez, and Jurgen Schmiduber.
...
13. Alex Graves, Navdeep Jaitly, and Abdel{-}rahman Mohamed.
...
14.
15. Awni Hannun, Andrew Maas, Daniel Jurafsky, and Andrew Ng.
...
16. Salah Hihi and Yoshua Bengio.
...
17. Sepp Hochreiter and Jurgen Schmidhuber.
    \newblock {Long Short-Term Memory}.
    \newblock \emph{Neural Computation}, 9\penalty0 (8):\penalty0 1735--1780,
    November 1997.
18. Sebastien Jean, Kyunghyun Cho, Roland Memisevic, and Yoshua Bengio.
...
19. Diederik Kingma and Jimmy Ba.
    ...
    \newblock In \emph{International Conference on Learning Representations}, 2015.
20. Jan Koutnik, Klaus Greff, Faustino Gomez, and Jurgen Schmidhuber.
    \newblock {A Clockwork RNN}.
    \newblock In \emph{International Conference on Machine Learning}, 2014.
21. Wang Ling, Edward Grefenstette, Karl~Moritz Hermann, Tomas Kocisky, Andrew
...
22. Liang Lu, Arnab Ghoshal, and Steve Renals.
    \newblock {Acoustic data-driven pronunciation lexicon for large vocabulary
    speech recognition}.
    \newblock In \emph{Automatic Speech Recognition and Understanding Workshop},
23.
24. Minh-Thang Luong and Christopher Manning.
...
25. Minh-Thang Luong, Ilya Sutskever, Quoc~V. Le, Oriol Vinyals, and Wojciech
    ...
    \newblock In \emph{{Association for Computational Linguistics}}, 2015.
26. Ian McGraw, Ibrahim Badr, and James Glass.
...
34. Rita Singh, Bhiksha Raj, and Richard Stern.
    ...
    (2), 2002.
35. Ilya Sutskever, Oriol Vinyals, and Quoc Le.
    \newblock {Sequence to Sequence Learning with Neural Networks}.
    \newblock In \emph{Neural Information Processing Systems}, 2014.
36. Richard Sutton and Andrew Barto.
    \newblock \emph{{Reinforcement Learning: An Introduction}}.
    \newblock MIT Press, 1998.
37. Oriol Vinyals, Lukasz Kaiser, Terry Koo, Slav Petrov, Ilya Sutskever, and
    Geoffrey~E. Hinton.
...
42. Yu~Zhang, William Chan, and Navdeep Jaitly.
    \newblock Very deep convolutional networks for end-to-end speech recognition.
    \newblock In \emph{IEEE International Conference on Acoustics, Speech and
    Signal Processing}, 2017.
43. Geoffrey Zweig, Chengzhu Yu, Jasha Droppo, and Andreas Stolcke.
