...
- Graves and Jaitly \[2016\] Alex Graves and Navdeep Jaitly. Towards end-to-end speech recognition with recurrent neural networks. In _Proc. ICML_, 2016.
- Miao et al. \[2015\] Yajie Miao, Mohammad Gowayyed, and Florian Metze. EESEN: End-to-end speech recognition using deep RNN models and WFST-based decoding. In _Proc. ASRU_, 2015.
- Bahdanau et al. \[2016\] Dzmitry Bahdanau, Jan Chorowski, Dmitriy Serdyuk, Philemon Brakel, and Yoshua Bengio. End-to-end attention-based large vocabulary speech recognition. In _Proc. ICASSP_, 2016.
- Zhang et al. \[2016\] Ying Zhang, Mohammad Pezeshki, Philémon Brakel, Saizheng Zhang, César Laurent, Yoshua Bengio, and Aaron Courville. Towards end-to-end speech recognition with deep convolutional neural networks. In _Proc. Interspeech_, 2016.
- Dario Amodei, et al. \[2016\] Dario Amodei, et al. Deep Speech 2: End-to-end speech recognition in English and Mandarin. In _Proc. ICML_, 2016.
- Lu et al. \[2016\] Liang Lu, Xing-Xing Zhang, and Steve Renals. On training the recurrent neural network encoder-decoder for large vocabulary end-to-end speech recognition. In _Proc. ICASSP_, 2016.
- Chan et al. \[2016\] William Chan, Navdeep Jaitly, Quoc V. Le, and Oriol Vinyals. Listen, attend and spell: A neural network for large vocabulary conversational speech recognition. In _Proc. ICASSP_, 2016.
- Bahl et al. \[1991\] L.R. Bahl, P.V. de Souza, P.S. Gopalakrishnan, D. Nahamoo, and M.A. Picheny. Context dependent modelling of phones in continuous speech using decision trees. In _Proc. DARPA Speech and Natural Language Processing Workshop_, 1991.
- Young et al. \[1994\] S.J. Young, J.J. Odell, and P.C. Woodland. Tree-based state tying for high accuracy acoustic modelling. In _Proc. ARPA Workshop on Human Language Technology_, 1994.
- Lang et al. \[1990\] Kevin J. Lang, Alex H. Waibel, and Geoffrey E. Hinton. A time-delay neural network architecture for isolated word recognition. _Neural Networks_, 3, 1990.
- Hochreiter and Schmidhuber \[1997\] Sepp Hochreiter and Jürgen Schmidhuber. Long short-term memory. _Neural Computation_, 9(8):1735–1780, November 1997. ISSN 0899-7667. doi: 10.1162/neco.1997.9.8.1735.
...
- Sak et al. \[2015a\] Haşim Sak, Andrew Senior, Kanishka Rao, and Françoise Beaufays. Fast and accurate recurrent neural network acoustic models for speech recognition. _arXiv preprint arXiv:1507.06947_, 2015a.
- Schuster and Paliwal \[1997\] Mike Schuster and Kuldip K. Paliwal. Bidirectional recurrent neural networks. _Signal Processing, IEEE Transactions on_, 45(11):2673–2681, 1997. ISSN 1053-587X. doi: 10.1109/78.650093.
- Sak et al. \[2015b\] Haşim Sak, Andrew Senior, Kanishka Rao, Ozan Irsoy, Alex Graves, Françoise Beaufays, and Johan Schalkwyk. Learning acoustic frame labeling for speech recognition with recurrent neural networks. In _Proc. ICASSP_, 2015b.
- Sak et al. \[2013\] Haşim Sak, Françoise Beaufays, Kaisuke Nakajima, and Cyril Allauzen. Language model verbalization for automatic speech recognition. In _Proc. ICASSP_, 2013.
- Dean et al. \[2012\] Jeffrey Dean, Greg Corrado, Rajat Monga, Kai Chen, Matthieu Devin, Quoc V. Le, Mark Z. Mao, Marc’Aurelio Ranzato, Andrew W. Senior, Paul A. Tucker, Ke Yang, and Andrew Y. Ng. Large scale distributed deep networks. In _NIPS_, 2012.
- Sak et al. \[2014\] Hasim Sak, Andrew Senior, and Francoise Beaufays. Long Short-Term Memory Recurrent Neural Network Architectures for Large Scale Acoustic Modeling. In _Proc. Interspeech_, 2014.
...
- Kuznetsov et al. \[2016\] Vitaly Kuznetsov, Hank Liao, Mehryar Mohri, Michael Riley, and Brian Roark. Learning N-gram language models from uncertain data. In _Proc. Interspeech_, 2016.
...
- Kapralova et al. \[2014\] Olga Kapralova, John Alex, Eugene Weinstein, Pedro Moreno, and Olivier Siohan. A big data approach to acoustic model training corpus selection. In _Proc. Interspeech_, 2014.
- Liao et al. \[2013\] Hank Liao, Erik McDermott, and Andrew Senior. Large scale deep neural network acoustic modeling with semi-supervised training data for youtube video transcription. In _Proc. ASRU_, 2013.
- Senior et al. \[2015\] A. Senior, H. Sak, and I. Shafran. Context dependent phone models for LSTM RNN acoustic modelling. In _Proc. ICASSP_, 2015.
