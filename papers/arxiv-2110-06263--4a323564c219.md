...
1.  1.  introduce a way to directly model speech summarization as an end-to-end task
2.  2.  demonstrate the effectiveness of restricted self-attention for speech inputs, critical for the success of end-to-end speech summarization, and
3.  3.  show that such an end-to-end model can also be applied to learn concepts directly from speech inputs, a potential spoken language understanding task.
