...
6. [arXiv:1503.02531](https://arxiv.org/abs/1503.02531)
7. L.~Lu, M.~Guo, and S.~Renals, ``Knowledge distillation for small-footprint
...
8. D.~Bagchi and W.~Hartmann, ``Learning from the best: A teacher-student
...
10. G.~Kurata and K.~Audhkhasi, ``Improved knowledge distillation from
...
11. G.~Tucker, M.~Wu, M.~Sun, S.~Panchapagesan, G.~Fu, and S.~Vitaladevuni, ``Model
    compression applied to small-footprint keyword spotting.'' in
    \emph{Interspeech}, 2016, pp. 1878--1882.
12. P.~Dighe, E.~Marchi, S.~Vishnubhotla, S.~Kajarekar, and D.~Naik, ``Knowledge
    transfer for efficient on-device false trigger mitigation,'' in \emph{IEEE
    International Conference on Acoustics, Speech and Signal Processing
    (ICASSP)}, 2021, pp. 6838--6842.
13. H.~jin Park, P.~Zhu, I.~Lopez-Moreno, and N.~A. Subrahmanya, ``Noisy
    student-teacher training for robust keyword spotting,'' in
    \emph{Interspeech}, 2021.
14. Y.~Wang, H.~Lv, D.~Povey, L.~Xie, and S.~Khudanpur, ``Wake word detection with
    alignment-free lattice-free mmi,'' in \emph{Proc. Interspeech 2020}, 2020.
15. C.~A. et~al., ``{Efficient keyword spotting using dilated convolutions and
    gating},'' in \emph{Proc. ICASSP 2019}, 2019.
16. D.~Povey, V.~Peddinti, D.~Galvez, P.~Ghahremani, V.~Manohar, X.~Na, Y.~Wang,
...
19. T.~Ko, V.~Peddinti, D.~Povey, M.~L. Seltzer, and S.~Khudanpur, ``A study on
...
20. T.~Ko, V.~Peddinti, D.~Povey, and S.~Khudanpur, ``{Audio augmentation for
    speech recognition},'' in \emph{Proc. Interspeech 2015}, 2015, pp.
    3586--3589.
21. D.~Snyder, G.~Chen, and D.~Povey, ``{MUSAN}: {A} {M}usic, {S}peech, and {N}oise
    {C}orpus,'' 2015, arXiv:1510.08484v1. [arXiv:1510.08484](https://arxiv.org/abs/1510.08484)
22. D.~Povey, G.~Cheng, Y.~Wang, K.~Li, H.~Xu, M.~Yarmohammadi, and S.~Khudanpur,
