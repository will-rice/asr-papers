...
arxiv_id: "2310.08225"
title:
  Fast Word Error Rate Estimation Using Self-Supervised Representations for Speech
  and Text
authors:
  - Chanho Park
  - Chengsong Lu
...
1.  1.  This paper proposes Fe-WER, a WER estimation model that uses average pooling and outperforms the baseline model in computational efficiency without compromising performance in WER estimation.
2.  2.  Experimental evidence shows that the combination of HuBERT \[[11](https://arxiv.org/html/2310.08225v2#bib.bib11)\] and XLM-R \[[7](https://arxiv.org/html/2310.08225v2#bib.bib7)\] achieves the best performance in WER estimation.
3.  3.  A comparative analysis of the distributions of target WER and WER estimates is presented including an examination of the average values per speaker.
