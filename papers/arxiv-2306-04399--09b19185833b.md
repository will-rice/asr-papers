...
arxiv_id: "2306.04399"
title:
  Transfer Learning of Transformer-based Speech Recognition Models from Czech
  to Slovak
authors:
  - Jan Lehečka
  - Josef V. Psutka
...
1.  1.  Assign the most probable output token to each audio frame.
2.  2.  Group sub-sequences with the same token into a single token.
3.  3.  Remove blank tokens.
