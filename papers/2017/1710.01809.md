...
- \[10\] H. Adel, N. T. Vu, F. Kraus, T. Schlippe, H. Li, and T. Schultz, “Recurrent neural network language modeling for code switching conversational speech,” in *ICASSP*.   IEEE, 2013.
- \[11\] K. Duh and K. Kirchhoff, “Automatic learning of language model structure,” in *COLING*, 2004.
- \[12\] A. El-Desoky, R. Schlüter, and H. Ney, “A hybrid morphologically decomposed factored language models for Arabic LVCSR,” in *NAACL*.   ACL, 2010.
- \[13\] H. Adel, N. T. Vu, and T. Schultz, “Combination of recurrent neural networks and factored language models for code-switching language modeling,” in *ACL*, 2013.
- \[14\] H. Adel, K. Kirchhoff, D. Telaar, N. T. Vu, T. Schlippe, and T. Schultz, “Features for factored language models for code-switching speech,” in *SLTU*, 2014.
...
- \[21\] N. Xue, F. Xia, F. Chiou, and M. Palmer, “The Penn Chinese treebank: Phrase structure annotation of a large corpus,” *Natural Language Engineering*, vol. 11, no. 2, p. 207, 2005.
- \[22\] M. Marcus, M. Marcinkiewicz, and B. Santorini, “Building a large annotated corpus of English: The Penn treebank,” *Computational Linguistics*, vol. 19, no. 2, pp. 313–330, 1993.
...
- \[25\] G. Haffari, M. Razavi, and A. Sarkar, “An ensemble model that combines syntactic and semantic clustering for discriminative dependency parsing,” in *ACL: HLT*, 2011, pp. 710–714.
...
- \[29\] J. MacQueen, “Some methods for classification and analysis of multivariate observations,” in *Berkeley symposium on mathematical statistics and probability*, 1967, pp. 281–297.
- \[30\] I. S. Dhillon, Y. Guan, and B. Kulis, “Weighted graph cuts without eigenvectors: a multilevel approach,” *Pattern Analysis and Machine Intelligence, IEEE Transactions on*, vol. 29, no. 11, pp. 1944–1957, 2007.
- \[31\] T. Mikolov, M. Karafiát, L. Burget, J. Cernocky, and S. Khudanpur, “Recurrent neural network based language model,” in *Interspeech*, 2010.
- \[32\] M. Bodén, “A guide to recurrent neural networks and backpropagation,” *The Dallas project, SICS technical report*, 2002.
- \[33\] T. Mikolov, S. Kombrink, L. Burget, J. Cernocky, and S. Khudanpur, “Extensions of recurrent neural network language model,” in *ICASSP*.   IEEE, 2011.
- \[34\] T. Mikolov, S. Kombrink, A. Deoras, L. Burget, and J. Cernockỳ, “RNNLM–recurrent neural network language modeling toolkit,” in *ASRU*.   IEEE, 2011.
...
- \[39\] N. T. Vu, D. Lyu, J. Weiner, D. Telaar, T. Schlippe, F. Blaicher, E. Chng, T. Schultz, and H. Li, “A first speech recognition system for Mandarin-English code-switch conversational speech,” in *ICASSP*.   IEEE, 2012.
- \[40\] D. Telaar, M. Wand, D. Gehrig, F. Putze, C. Amma, D. Heger, N. Vu, M. Erhardt, T. Schlippe, M. Janke, C. Herff, and T. Schultz, “Automatic speech recognition of Cantonese-English code-mixing utterances,” in *Interspeech*, 2014.
