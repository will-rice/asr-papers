---
arxiv_id: '1703.04650'
title: Joint Learning of Correlated Sequence Labelling Tasks Using Bidirectional Recurrent
  Neural Networks
authors:
- Vardaan Pahuja
- Anirban Laha
...
1.  1.
    …and it hasn’t been refined enough yet. It needs to be worked on until it can speak fluently
2.  2.
    This young doctor, Tom Ferguson, was the medical editor of the Whole Earth Catalog.
...
- \[23\] K. Cho, B. van Merrienboer, Ç. Gülçehre, D. Bahdanau, F. Bougares, H. Schwenk, and Y. Bengio, “Learning phrase representations using RNN encoder-decoder for statistical machine translation,” in *Proceedings of the 2014 Conference on Empirical Methods in Natural Language Processing, EMNLP 2014*, 2014, pp. 1724–1734.
...
- \[26\] N. Ueffing, M. Bisani, and P. Vozila, “Improved models for automatic punctuation prediction for spoken and written text.” in *INTERSPEECH*, F. Bimbot, C. Cerisara, C. Fougeron, G. Gravier, L. Lamel, F. Pellegrino, and P. Perrier, Eds.   ISCA, 2013, pp. 3097–3101.
- \[27\] O. Tilk and T. Alumäe, “Bidirectional recurrent neural network with attention mechanism for punctuation restoration,” *Interspeech 2016*, pp. 3047–3051, 2016.
...
- \[30\] X. Ma and E. Hovy, “End-to-end sequence labeling via bi-directional lstm-cnns-crf,” in *Proceedings of the 54th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, August 2016, pp. 1064–1074.
