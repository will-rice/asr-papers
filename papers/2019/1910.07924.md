---
arxiv_id: '1910.07924'
title: 'LibriVoxDeEn: A Corpus for German-to-English Speech Translation and German
  Speech Recognition'
authors:
- Benjamin Beilharz
- Xin Sun
...
1.  1.
    Creation of German speech recognition corpus (see Section \StrSubstitute0.)

    - •
      Data download

      - –
        Download German audio books from *LibriVox* web platform¹¹1[https://librivox.org](https://librivox.org)
      - –
...
2.  2.
    Creation of German-English Speech Translation Corpus (see Sections \StrSubstitute0. and \StrSubstitute0.)
    ...
    - •
      ...
      - –
        German-English sentence alignments using *hunalign* \[Varga et al., 2005\]
      - –
...
German sentence segmentation was done using *spaCy* based on a medium sized German corpus⁹⁹9[https://spacy.io/models/de#de_core_news_md](https://spacy.io/models/de#de_core_news_md) that contains the TIGER corpus¹⁰¹⁰10[https://www.ims.uni-stuttgart.de/forschung/\
...
For a manual evaluation of our dataset, we split the corpus into three bins according to ranges $`({- 0.3},0.3\rbrack`$, $`(0.3,0.8\rbrack`$ and $`(0.8,\infty)`$ of the *hunalign* confidence score (see Table 5).
