---
arxiv_id: '1903.04567'
title: Bridging the Gap Between Monaural Speech Enhancement and Recognition with Distortion-Independent
  Acoustic Modeling
authors:
- Peidong Wang
- Ke Tan
...
TABLE I: WERs of the five acoustic models on WSJ. *bab* and *caf* denote ADTbabble and ADTcafeteria1, respectively. *w/o* refers to noisy evaluation data without speech enhancement (i.e. unenhanced speech), and *w/* evaluation data with enhancement.
...
TABLE III: WERs of the five acoustic models on CHiME-2. *chime-2* denotes the official CHiME-2 evaluation set. *ADT* refers to the average WER of ADTbabble and ADTcafeteria1. See TABLE I caption for other notations.
...
- \[5\] T. Gao, J. Du, L. Dai, and C. Lee, “SNR-based progressive learning of deep neural network for speech enhancement.” in *Proc. of INTERSPEECH*, 2016, pp. 3713–3717.
- \[6\] T. Gao, J. Du, Y. Xu, L. Liu, C.and Dai, and C. Lee, “Improving deep neural network based speech enhancement in low SNR environments,” in *International Conference on Latent Variable Analysis and Signal Separation*.   Springer, 2015, pp. 75–82.
...
- \[8\] J. Heymann, L. Drude, and H. Reinhold, “Wide residual BLSTM network with discriminative speaker adaptation for robust speech recognition,” in *Proceedings of the 4th International Workshop on Speech Processing in Everyday Environments (CHiME’16)*, 2016, pp. 12–17.
...
- \[20\] E. Vincent, J. Barker, S. Watanabe, J. Le Roux, F. Nesta, and M. Matassoni, “The second ‘chime’ speech separation and recognition challenge: Datasets, tasks and baselines,” in *Acoustics, Speech and Signal Processing (ICASSP), 2013 IEEE International Conference on*.   IEEE, 2013, pp. 126–130.
