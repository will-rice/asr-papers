...
We also use Transformer to train a baseline MT model, as shown in the right part of Figure 1. The difference between MT model and ASR/ST model is the input to the encoder. In MT model, $`X = \left( x_{1},x_{2},\cdots,x_{n} \right)`$ is a sequence of tokens, representing source sentence. We embed the words in sequence *X* into a real continuous space with the dimension of $`{\mathbb{R}}_{m\hspace{0pt}o\hspace{0pt}d\hspace{0pt}e\hspace{0pt}l}^{d}`$, which can be fed into a neural network.
...
- \[3\] Y. Wu, M. Schuster, Z. Chen, Q. V. Le, and e. a. Mohammad Norouzi, *Google’s neural machine translation system: bridging the gap between human and machine translation*.   arXiv preprint arXix:1609.08144, 2016.
- \[4\] C.-C. Chiu, T. N. Sainath, Y. Wu, R. Prabhavalkar, P. Nguyen, Z. Chen, A. Kannan, R. J. Weiss, K. Rao, K. Gonina *et al.*, “State-of-the-art speech recognition with sequence-to-sequence models,” *in Proc. ICASSP*, 2017.
- \[5\] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, Ł. Kaiser, and I. Polosukhin, “Attention is all you need,” *Advances in Neural Information Processing Systems*, pp. 5998–6008, 2017.
- \[6\] A. Anastasopoulos, D. Chiang, and L. Duong, “An unsupervised probability model for speech-to-translation alignment of low-resource languages,” *in Proc. EMNLP*, 2016.
- \[7\] L. Duong, A. Anastasopoulos, D. Chiang, S. Bird, and T. Cohn, “An attentional model for speech translation without transcription,” *in Proc. NAACL*, 2016.
- \[8\] A. Bérard, O. Pietquin, C. Servan, and L. Besacier, “Listen and translate: A proof of concept for end-to-end speech-to-text translation,” *in NeurIPS Workshop on End-to-end Learning for Speech and Audio Processing*, 2016.
- \[9\] R. J. Weiss, J. Chorowski, N. Jaitly, Y. Wu, and Z. Chen, “Sequence-to-sequence models can directly translate foreign speech,” *in Proc. Interspeech*, 2017.
...
- \[13\] M. Freitag, Y. Al-Onaizan, and B. Sankaran, “Ensemble distillation for neural machine translation,” *arXiv preprint arXiv:1702.01802*, 2017.
- \[14\] J. Yim, D. Joo, J. Bae, and J. Kim, “A gift from knowledge distillation: Fast optimization, network minimization and transfer learning,” *in Proc. CVPR*, pp. 4133–4141, 2017.
- \[15\] A. Romero, N. Ballas, S. E. Kahou, A. Chassang, C. Gatta, and Y. Bengio, “Fitnets: Hints for thin deep nets,” *in Proc. ICLR*, 2015.
- \[16\] Y. Kim and A. M. Rush, “Sequence-level knowledge distillation,” *in Proc. EMNLP*, 2016.
- \[17\] D. Bahdanau, J. Chorowski, D. Serdyuk, P. Brakel, and Y. Bengio, “End-to-end attention-based large vocabulary speech recognition,” *in Proc. ICASSP*, 2016.
- \[18\] Y. Li, J. Yang, Y. Song, L. Cao, J. Luo, and L.-J. Li, “Learning from noisy labels with distillation,” *in Proc. ICCV*, pp. 1910–1918, 2017.
- \[19\] C. Yang, L. Xie, S. Qiao, and A. Yuille, “Knowledge distillation in generations: More tolerant teachers educate better students,” *in Proc. CVPR*, 2018.
- \[20\] R. Anil, G. Pereyra, A. Passos, R. Ormandi, G. E. Dahl, and G. E. Hinton, “Large scale distributed neural network training through online distillation,” *arXiv preprint arXiv:1804.03235*, 2018.
- \[21\] X. Tan, Y. Ren, D. He, T. Qin, Z. Zhao, and T.-Y. Liu, “Multilingual neural machine translation with knowledge distillation,” *in Proc. ICLR*, 2019.
- \[22\] L. Dong, S. Xu, and B. Xu, “Speech-transformer: a no-recurrence sequence-to-sequence model for speech recognition,” *in Proc. ICASSP*, pp. 5884–5888, 2018.
- \[23\] S. Zhou, L. Dong, S. Xu, and B. Xu, “Syllable-based sequence-to-sequence speech recognition with the transformer in mandarin chinese,” *in Proc. Interspeech*, 2018.
- \[24\] H. Sak, A. Senior, K. Rao, and F. Beaufays, “Fast and accurate recurrent neural network acoustic models for speech recognition,” *in Proc. ICASSP*, 2015.
- \[25\] A. Kannan, Y. Wu, P. Nguyen, T. N. Sainath, Z. Chen, and R. Prabhavalkar, “An analysis of incorporating an external language model into a sequence-to-sequence model,” *in Proc. ICASSP*, pp. 1–5828, 2018.
- \[26\] A. C. Kocabiyikoglu, L. Besacier, and O. Kraif, “Augmenting librispeech with french translations: A multimodal corpus for direct speech translation evaluation,” *Language Resources and Evaluation*, 2018.
- \[27\] R. Sennrich, B. Haddow, and A. Birch, “Neural machine translation of rare words with subword units,” *in Proc. ACL*, 2016.
- \[28\] K. Papineni, S. Roukos, T. Ward, and W.-J. Zhu, “Bleu: a method for automatic evaluation of machine translation,” *in Proc. ACL*, pp. 311–318, 2002.
