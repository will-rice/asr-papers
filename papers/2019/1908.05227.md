---
arxiv_id: '1908.05227'
title: Exploiting semi-supervised training through a dropout regularization in end-to-end
  speech recognition
authors:
- Subhadeep Dey
- Petr Motlicek
...
2.  2.
    Data-selection: augment the adaptation data with this utterance if the entropy or the decoding-score is above a threshold
3.  3.
