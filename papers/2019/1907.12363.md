...
arxiv_id: "1907.12363"
title:
  A comparison of Deep Learning performances with other machine learning algorithms
...
1.  1.  First, training common ML algorithms used for unbalanced data on our data set, and select the best configuration.
2.  2.  Then optimising a DL algorithm on our data set from the best configuration selected.
