...
1.  1.  Train an RNN-T model as in \[1\];
2.  2.  Take the encoder trained in step (1), freeze it, and train a LAS decoder as in \[3\].
3.  3.  “Deep finetuning”: train the shared encoder and both decoders at the same time with the combined loss.
