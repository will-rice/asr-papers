...
arxiv_id: "2106.08126"
title:
  "Dialectal Speech Recognition and Translation of Swiss German Speech to Standard
...
| _f hr a\_ g ax t_  | _f hr a\_ k sh_ | \_e_r t m eh n l i\_\_ | \_g ih m i\_\_ | _g hr ih n t_ | _k a sh_    |
| riecht             | riechst         | gläschen               | schwimmbad     | kneipe        | zweites     |
| _sh m oe k c ax t_ | _sh m oe k sh_  | \_g l e\_ s l i\_\_    | _b a\_ d ih_   | _b ai ts_     | _ts v ai t_ |
...
Swiss German tends to merge words beyond compounding, not preserving word stems Hollenstein and Aepli (2014). For instance, the Swiss German ‘_hemmer_’ is the translation of ‘_haben wir_’ in standard German (English: ‘_have we_’). We identified approximately $`8000`$ clitics in our corpus. We incorporate them in the decoding process by updating lexicon and LM. Following the example above the translated clitic ‘_haben#wir_‘ with the corresponding Swiss pronunciation is added to the lexicon. As for the LM, we merge occurrences of relevant word pairs and interpolate with the unmerged LM.
...
- Ali et al. (2021) Ahmed Ali, Shammur Chowdhury, Mohamed Afify, Wassim El-Hajj, Hazem Hajj, Mourad Abbas, Amir Hussein, Nada Ghneim, Mohammad Abushariah, and Assal Alqudah. 2021. [Connecting Arabs: Bridging the gap in dialectal speech recognition](https://doi.org/10.1145/3451150). _Communications of the ACM_, 64(4):124–129.
- Ali (2018) Ahmed Mohamed Abdel Maksoud Ali. 2018. _Multi-Dialect Arabic Broadcast Speech Recognition_. Ph.D. thesis, University of Edinburgh, Edinburgh, UK.
...
- Bourlard and Dupont (1996) Hervé Bourlard and Stéphane Dupont. 1996. A new ASR approach based on independent processing and recombination of partial frequency bands. In _Proc. Int. Conf. on Spoken Language Processing (ICSLP)_, volume 1, pages 426–429.
...
- Chen and Huo (2016) Kai Chen and Qiang Huo. 2016. [Training deep bidirectional lstm acoustic model for lvcsr by a context-sensitive-chunk bptt approach](https://doi.org/10.1109/TASLP.2016.2539499). _IEEE/ACM Transactions on Audio, Speech, and Language Processing_, 24(7):1185–1193.
- Deoras et al. (2011) Anoop Deoras, Tomáš Mikolov, and Kenneth Church. 2011. A Fast Re-scoring Strategy to Capture Long-Distance Dependencies. In _Proceedings of the 2011 Conference on Empirical Methods in Natural Language Processing_, pages 1116–1127, Edinburgh, Scotland, UK. Association for Computational Linguistics.
- Garner et al. (2014) Philip N. Garner, David Imseng, and Thomas Meyer. 2014. Automatic Speech Recognition and Translation of a Swiss German Dialect: Walliserdeutsch. In _Proc. of the Ann. Conf. of the Int. Speech Commun. Assoc. (Interspeech)_, Singapore.
...
- Hollenstein and Aepli (2014) Nora Hollenstein and Noëmi Aepli. 2014. Compilation of a Swiss German dialect corpus and its application to PoS tagging. In _Proceedings of the First Workshop on Applying NLP Tools to Similar Languages, Varieties and Dialects_, pages 85–94.
- Hussein et al. (2021) Amir Hussein, Shinji Watanabe, and Ahmed Ali. 2021. [Arabic Speech Recognition by End-to-End, Modular Systems and Human](http://arxiv.org/abs/2101.08454). _arXiv:2101.08454 \[cs, eess\]_.
...
- Kneser and Ney (1995) Reinhard Kneser and Hermann Ney. 1995. Improved backing-off for m-gram language modeling. In _Proc. IEEE Int. Conf. on Acoustics, Speech and Signal Processing (ICASSP)_, volume 1, pages 181–184.
- Li et al. (2019) Jason Li, Vitaly Lavrukhin, Boris Ginsburg, Ryan Leary, Oleksii Kuchaiev, Jonathan M Cohen, Huyen Nguyen, and Ravi Teja Gadde. 2019. Jasper: An end-to-end convolutional neural acoustic model. _arXiv preprint arXiv:1904.03288_.
- Nigmatulina et al. (2020) Iuliia Nigmatulina, Tannon Kew, and Tanja Samardzic. 2020. [ASR for non-standardised languages with dialectal variation: the case of Swiss German](https://www.aclweb.org/anthology/2020.vardial-1.2). In _Proceedings of the 7th Workshop on NLP for Similar Languages, Varieties and Dialects_, pages 15–24, Barcelona, Spain (Online). International Committee on Computational Linguistics (ICCL).
- Papineni et al. (2002) Kishore Papineni, Salim Roukos, Todd Ward, and Wei-Jing Zhu. 2002. [Bleu: a method for automatic evaluation of machine translation](https://doi.org/10.3115/1073083.1073135). In _Proceedings of the 40th Annual Meeting of the Association for Computational Linguistics_, pages 311–318. Association for Computational Linguistics.
- Plüss et al. (2020) Michel Plüss, Lukas Neukom, and Manfred Vogel. 2020. Swiss parliaments corpus, an automatically aligned swiss german speech to standard german text corpus. _arXiv preprint arXiv:2010.02810_.
- Schmidt et al. (2020) Larissa Schmidt, Lucy Linder, Sandra Djambazovska, Alexandros Lazaridis, Tanja Samardžić, and Claudiu Musat. 2020. [A Swiss German Dictionary: Variation in Speech and Writing](http://arxiv.org/abs/2004.00139). _arXiv:2004.00139 \[cs\]_.
- Stadtschnitzer and Schmidt (2018) Michael Stadtschnitzer and Christoph Schmidt. 2018. Adaptation and training of a swiss german speech recognition system using data-driven pronunciation modelling. _Proceedings of DAGA-44. Jahrestagung für Akustik, München, Germany_.
- Sundermeyer et al. (2012) Martin Sundermeyer, Ralf Schlüter, and Hermann Ney. 2012. LSTM neural networks for language modeling. In _Proc. of the Ann. Conf. of the Int. Speech Commun. Assoc. (Interspeech)_, pages 194–197, Portland, OR, USA.
- Xiong et al. (2016) Wayne Xiong, Jasha Droppo, Xuedong Huang, Frank Seide, Mike Seltzer, Andreas Stolcke, Dong Yu, and Geoffrey Zweig. 2016. Achieving human parity in conversational speech recognition. _arXiv preprint arXiv:1610.05256_.
- Zhang et al. (2017) Xiaohui Zhang, Vimal Manohar, Daniel Povey, and Sanjeev Khudanpur. 2017. [Acoustic Data-Driven Lexicon Learning Based on a Greedy Pronunciation Selection Framework](https://doi.org/10.21437/Interspeech.2017-588). In _Proc. of the Ann. Conf. of the Int. Speech Commun. Assoc. (Interspeech)_, pages 2541–2545. ISCA.
